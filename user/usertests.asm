...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	b6a50513          	addi	a0,a0,-1174 # 5ba8 <malloc+0x3ec>
      46:	00005097          	auipc	ra,0x5
      4a:	6b8080e7          	jalr	1720(ra) # 56fe <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	b4850513          	addi	a0,a0,-1208 # 5bc8 <malloc+0x40c>
      88:	00005097          	auipc	ra,0x5
      8c:	676080e7          	jalr	1654(ra) # 56fe <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	b3850513          	addi	a0,a0,-1224 # 5be0 <malloc+0x424>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	b3a50513          	addi	a0,a0,-1222 # 5c00 <malloc+0x444>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	b0250513          	addi	a0,a0,-1278 # 5be8 <malloc+0x42c>
      ee:	00005097          	auipc	ra,0x5
      f2:	610080e7          	jalr	1552(ra) # 56fe <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	b0e50513          	addi	a0,a0,-1266 # 5c10 <malloc+0x454>
     10a:	00005097          	auipc	ra,0x5
     10e:	5f4080e7          	jalr	1524(ra) # 56fe <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	b0c50513          	addi	a0,a0,-1268 # 5c38 <malloc+0x47c>
     134:	00005097          	auipc	ra,0x5
     138:	28a080e7          	jalr	650(ra) # 53be <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	af850513          	addi	a0,a0,-1288 # 5c38 <malloc+0x47c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	af458593          	addi	a1,a1,-1292 # 5c48 <malloc+0x48c>
     15c:	00005097          	auipc	ra,0x5
     160:	232080e7          	jalr	562(ra) # 538e <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ad050513          	addi	a0,a0,-1328 # 5c38 <malloc+0x47c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ad458593          	addi	a1,a1,-1324 # 5c50 <malloc+0x494>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	aa450513          	addi	a0,a0,-1372 # 5c38 <malloc+0x47c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	a8e50513          	addi	a0,a0,-1394 # 5c58 <malloc+0x49c>
     1d2:	00005097          	auipc	ra,0x5
     1d6:	52c080e7          	jalr	1324(ra) # 56fe <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000278 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     294:	7c850513          	addi	a0,a0,1992 # 5a58 <malloc+0x29c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	7b4a8a93          	addi	s5,s5,1972 # 5a58 <malloc+0x29c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	95a50513          	addi	a0,a0,-1702 # 5c80 <malloc+0x4c4>
     32e:	00005097          	auipc	ra,0x5
     332:	3d0080e7          	jalr	976(ra) # 56fe <printf>
      exit(1);
     336:	4505                	li	a0,1
     ...
     34e:	95650513          	addi	a0,a0,-1706 # 5ca0 <malloc+0x4e4>
     352:	00005097          	auipc	ra,0x5
     356:	3ac080e7          	jalr	940(ra) # 56fe <printf>
        exit(1);
     35a:	4505                	li	a0,1
...
0000000000000364 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     38a:	932a0a13          	addi	s4,s4,-1742 # 5cb8 <malloc+0x4fc>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     436:	88e50513          	addi	a0,a0,-1906 # 5cc0 <malloc+0x504>
     43a:	00005097          	auipc	ra,0x5
     43e:	2c4080e7          	jalr	708(ra) # 56fe <printf>
      exit(1);
     442:	4505                	li	a0,1
     ...
     454:	88850513          	addi	a0,a0,-1912 # 5cd8 <malloc+0x51c>
     458:	00005097          	auipc	ra,0x5
     45c:	2a6080e7          	jalr	678(ra) # 56fe <printf>
      exit(1);
     460:	4505                	li	a0,1
     ...
     472:	89a50513          	addi	a0,a0,-1894 # 5d08 <malloc+0x54c>
     476:	00005097          	auipc	ra,0x5
     47a:	288080e7          	jalr	648(ra) # 56fe <printf>
      exit(1);
     47e:	4505                	li	a0,1
     ...
     48c:	8b050513          	addi	a0,a0,-1872 # 5d38 <malloc+0x57c>
     490:	00005097          	auipc	ra,0x5
     494:	26e080e7          	jalr	622(ra) # 56fe <printf>
      exit(1);
     498:	4505                	li	a0,1
     ...
     4aa:	8a250513          	addi	a0,a0,-1886 # 5d48 <malloc+0x58c>
     4ae:	00005097          	auipc	ra,0x5
     4b2:	250080e7          	jalr	592(ra) # 56fe <printf>
      exit(1);
     4b6:	4505                	li	a0,1
...
00000000000004c0 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	894a0a13          	addi	s4,s4,-1900 # 5d78 <malloc+0x5bc>
    n = write(fds[1], "x", 1);
     4ec:	00005a97          	auipc	s5,0x5
     4f0:	764a8a93          	addi	s5,s5,1892 # 5c50 <malloc+0x494>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     596:	7ee50513          	addi	a0,a0,2030 # 5d80 <malloc+0x5c4>
     59a:	00005097          	auipc	ra,0x5
     59e:	164080e7          	jalr	356(ra) # 56fe <printf>
      exit(1);
     5a2:	4505                	li	a0,1
     ...
     5b4:	7e850513          	addi	a0,a0,2024 # 5d98 <malloc+0x5dc>
     5b8:	00005097          	auipc	ra,0x5
     5bc:	146080e7          	jalr	326(ra) # 56fe <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	76e50513          	addi	a0,a0,1902 # 5d38 <malloc+0x57c>
     5d2:	00005097          	auipc	ra,0x5
     5d6:	12c080e7          	jalr	300(ra) # 56fe <printf>
      exit(1);
     5da:	4505                	li	a0,1
     ...
     5e8:	7e450513          	addi	a0,a0,2020 # 5dc8 <malloc+0x60c>
     5ec:	00005097          	auipc	ra,0x5
     5f0:	112080e7          	jalr	274(ra) # 56fe <printf>
      exit(1);
     5f4:	4505                	li	a0,1
     ...
     606:	7de50513          	addi	a0,a0,2014 # 5de0 <malloc+0x624>
     60a:	00005097          	auipc	ra,0x5
     60e:	0f4080e7          	jalr	244(ra) # 56fe <printf>
      exit(1);
     612:	4505                	li	a0,1
...
000000000000061c <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65c:	5f058593          	addi	a1,a1,1520 # 5c48 <malloc+0x48c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     678:	5c450513          	addi	a0,a0,1476 # 5c38 <malloc+0x47c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a4:	59850513          	addi	a0,a0,1432 # 5c38 <malloc+0x47c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b8:	58450513          	addi	a0,a0,1412 # 5c38 <malloc+0x47c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f6:	77e58593          	addi	a1,a1,1918 # 5e70 <malloc+0x6b4>
     6fa:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     738:	50450513          	addi	a0,a0,1284 # 5c38 <malloc+0x47c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77c:	69850513          	addi	a0,a0,1688 # 5e10 <malloc+0x654>
     780:	00005097          	auipc	ra,0x5
     784:	f7e080e7          	jalr	-130(ra) # 56fe <printf>
    exit(1);
     788:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     798:	69c50513          	addi	a0,a0,1692 # 5e30 <malloc+0x674>
     79c:	00005097          	auipc	ra,0x5
     7a0:	f62080e7          	jalr	-158(ra) # 56fe <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7a4:	8652                	mv	a2,s4
     7a6:	85d6                	mv	a1,s5
     7a8:	00005517          	auipc	a0,0x5
     7ac:	69850513          	addi	a0,a0,1688 # 5e40 <malloc+0x684>
     7b0:	00005097          	auipc	ra,0x5
     7b4:	f4e080e7          	jalr	-178(ra) # 56fe <printf>
    exit(1);
     7b8:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c8:	69c50513          	addi	a0,a0,1692 # 5e60 <malloc+0x6a4>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	f32080e7          	jalr	-206(ra) # 56fe <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7d4:	8652                	mv	a2,s4
     7d6:	85d6                	mv	a1,s5
     7d8:	00005517          	auipc	a0,0x5
     7dc:	66850513          	addi	a0,a0,1640 # 5e40 <malloc+0x684>
     7e0:	00005097          	auipc	ra,0x5
     7e4:	f1e080e7          	jalr	-226(ra) # 56fe <printf>
    exit(1);
     7e8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7fa:	68250513          	addi	a0,a0,1666 # 5e78 <malloc+0x6bc>
     7fe:	00005097          	auipc	ra,0x5
     802:	f00080e7          	jalr	-256(ra) # 56fe <printf>
    exit(1);
     806:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     818:	68450513          	addi	a0,a0,1668 # 5e98 <malloc+0x6dc>
     81c:	00005097          	auipc	ra,0x5
     820:	ee2080e7          	jalr	-286(ra) # 56fe <printf>
    exit(1);
     824:	4505                	li	a0,1
...
000000000000082e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84c:	67050513          	addi	a0,a0,1648 # 5eb8 <malloc+0x6fc>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     864:	68098993          	addi	s3,s3,1664 # 5ee0 <malloc+0x724>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     868:	00005a97          	auipc	s5,0x5
     86c:	6b0a8a93          	addi	s5,s5,1712 # 5f18 <malloc+0x75c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b2:	60a50513          	addi	a0,a0,1546 # 5eb8 <malloc+0x6fc>
  ...
  if(unlink("small") < 0){
     ...
     8ee:	5ce50513          	addi	a0,a0,1486 # 5eb8 <malloc+0x6fc>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     918:	5ac50513          	addi	a0,a0,1452 # 5ec0 <malloc+0x704>
     91c:	00005097          	auipc	ra,0x5
     920:	de2080e7          	jalr	-542(ra) # 56fe <printf>
    exit(1);
     924:	4505                	li	a0,1
     ...
     934:	5c050513          	addi	a0,a0,1472 # 5ef0 <malloc+0x734>
     938:	00005097          	auipc	ra,0x5
     93c:	dc6080e7          	jalr	-570(ra) # 56fe <printf>
      exit(1);
     940:	4505                	li	a0,1
     ...
     950:	5dc50513          	addi	a0,a0,1500 # 5f28 <malloc+0x76c>
     954:	00005097          	auipc	ra,0x5
     958:	daa080e7          	jalr	-598(ra) # 56fe <printf>
      exit(1);
     95c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96c:	5e850513          	addi	a0,a0,1512 # 5f50 <malloc+0x794>
     970:	00005097          	auipc	ra,0x5
     974:	d8e080e7          	jalr	-626(ra) # 56fe <printf>
    exit(1);
     978:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     988:	5ec50513          	addi	a0,a0,1516 # 5f70 <malloc+0x7b4>
     98c:	00005097          	auipc	ra,0x5
     990:	d72080e7          	jalr	-654(ra) # 56fe <printf>
    exit(1);
     994:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a4:	5e850513          	addi	a0,a0,1512 # 5f88 <malloc+0x7cc>
     9a8:	00005097          	auipc	ra,0x5
     9ac:	d56080e7          	jalr	-682(ra) # 56fe <printf>
    exit(1);
     9b0:	4505                	li	a0,1
...
00000000000009ba <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d6:	5d650513          	addi	a0,a0,1494 # 5fa8 <malloc+0x7ec>
  ...
  fd = open("big", O_RDONLY);
     ...
     a28:	58450513          	addi	a0,a0,1412 # 5fa8 <malloc+0x7ec>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a70:	54450513          	addi	a0,a0,1348 # 5fb0 <malloc+0x7f4>
     a74:	00005097          	auipc	ra,0x5
     a78:	c8a080e7          	jalr	-886(ra) # 56fe <printf>
    exit(1);
     a7c:	4505                	li	a0,1
     ...
     a8c:	54850513          	addi	a0,a0,1352 # 5fd0 <malloc+0x814>
     a90:	00005097          	auipc	ra,0x5
     a94:	c6e080e7          	jalr	-914(ra) # 56fe <printf>
      exit(1);
     a98:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aa8:	55450513          	addi	a0,a0,1364 # 5ff8 <malloc+0x83c>
     aac:	00005097          	auipc	ra,0x5
     ab0:	c52080e7          	jalr	-942(ra) # 56fe <printf>
    exit(1);
     ab4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ad4:	4d850513          	addi	a0,a0,1240 # 5fa8 <malloc+0x7ec>
     ...
     afe:	51e50513          	addi	a0,a0,1310 # 6018 <malloc+0x85c>
     b02:	00005097          	auipc	ra,0x5
     b06:	bfc080e7          	jalr	-1028(ra) # 56fe <printf>
        exit(1);
     b0a:	4505                	li	a0,1
     ...
     b1a:	52a50513          	addi	a0,a0,1322 # 6040 <malloc+0x884>
     b1e:	00005097          	auipc	ra,0x5
     b22:	be0080e7          	jalr	-1056(ra) # 56fe <printf>
      exit(1);
     b26:	4505                	li	a0,1
     ...
     b36:	52650513          	addi	a0,a0,1318 # 6058 <malloc+0x89c>
     b3a:	00005097          	auipc	ra,0x5
     b3e:	bc4080e7          	jalr	-1084(ra) # 56fe <printf>
      exit(1);
     b42:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b52:	53250513          	addi	a0,a0,1330 # 6080 <malloc+0x8c4>
     b56:	00005097          	auipc	ra,0x5
     b5a:	ba8080e7          	jalr	-1112(ra) # 56fe <printf>
    exit(1);
     b5e:	4505                	li	a0,1
...
0000000000000b68 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	e7450513          	addi	a0,a0,-396 # 59f0 <malloc+0x234>
  ...
  write(fd, "hello", SZ);
     ...
     b98:	52458593          	addi	a1,a1,1316 # 60b8 <malloc+0x8fc>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	e4050513          	addi	a0,a0,-448 # 59f0 <malloc+0x234>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	e2a50513          	addi	a0,a0,-470 # 59f0 <malloc+0x234>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	e1450513          	addi	a0,a0,-492 # 59f0 <malloc+0x234>
  ...
  write(fd1, "yyy", 3);
     ...
     bf4:	51058593          	addi	a1,a1,1296 # 6100 <malloc+0x944>
  ...
  unlink("unlinkread");
     ...
     c5c:	d9850513          	addi	a0,a0,-616 # 59f0 <malloc+0x234>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c7c:	42050513          	addi	a0,a0,1056 # 6098 <malloc+0x8dc>
     c80:	00005097          	auipc	ra,0x5
     c84:	a7e080e7          	jalr	-1410(ra) # 56fe <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c98:	42c50513          	addi	a0,a0,1068 # 60c0 <malloc+0x904>
     c9c:	00005097          	auipc	ra,0x5
     ca0:	a62080e7          	jalr	-1438(ra) # 56fe <printf>
    exit(1);
     ca4:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cb4:	43050513          	addi	a0,a0,1072 # 60e0 <malloc+0x924>
     cb8:	00005097          	auipc	ra,0x5
     cbc:	a46080e7          	jalr	-1466(ra) # 56fe <printf>
    exit(1);
     cc0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cd0:	43c50513          	addi	a0,a0,1084 # 6108 <malloc+0x94c>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	a2a080e7          	jalr	-1494(ra) # 56fe <printf>
    exit(1);
     cdc:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cec:	44050513          	addi	a0,a0,1088 # 6128 <malloc+0x96c>
     cf0:	00005097          	auipc	ra,0x5
     cf4:	a0e080e7          	jalr	-1522(ra) # 56fe <printf>
    exit(1);
     cf8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d08:	44450513          	addi	a0,a0,1092 # 6148 <malloc+0x98c>
     d0c:	00005097          	auipc	ra,0x5
     d10:	9f2080e7          	jalr	-1550(ra) # 56fe <printf>
    exit(1);
     d14:	4505                	li	a0,1
...
0000000000000d1e <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	35058593          	addi	a1,a1,848 # 60b8 <malloc+0x8fc>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d8c:	3e858593          	addi	a1,a1,1000 # 6170 <malloc+0x9b4>
     d90:	00005517          	auipc	a0,0x5
     d94:	3d850513          	addi	a0,a0,984 # 6168 <malloc+0x9ac>
  ...
  unlink("lf1");
     ...
     da8:	3c450513          	addi	a0,a0,964 # 6168 <malloc+0x9ac>
     dac:	00004097          	auipc	ra,0x4
     db0:	612080e7          	jalr	1554(ra) # 53be <unlink>
  if(open("lf1", 0) >= 0){
     db4:	4581                	li	a1,0
     db6:	00005517          	auipc	a0,0x5
     dba:	3b250513          	addi	a0,a0,946 # 6168 <malloc+0x9ac>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	3a450513          	addi	a0,a0,932 # 6170 <malloc+0x9b4>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e08:	36c58593          	addi	a1,a1,876 # 6170 <malloc+0x9b4>
     e0c:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e1e:	35650513          	addi	a0,a0,854 # 6170 <malloc+0x9b4>
     e22:	00004097          	auipc	ra,0x4
     e26:	59c080e7          	jalr	1436(ra) # 53be <unlink>
  if(link("lf2", "lf1") >= 0){
     e2a:	00005597          	auipc	a1,0x5
     e2e:	33e58593          	addi	a1,a1,830 # 6168 <malloc+0x9ac>
     e32:	00005517          	auipc	a0,0x5
     e36:	33e50513          	addi	a0,a0,830 # 6170 <malloc+0x9b4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e4a:	32258593          	addi	a1,a1,802 # 6168 <malloc+0x9ac>
     e4e:	00005517          	auipc	a0,0x5
     e52:	42a50513          	addi	a0,a0,1066 # 6278 <malloc+0xabc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e74:	30850513          	addi	a0,a0,776 # 6178 <malloc+0x9bc>
     e78:	00005097          	auipc	ra,0x5
     e7c:	886080e7          	jalr	-1914(ra) # 56fe <printf>
    exit(1);
     e80:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e90:	30450513          	addi	a0,a0,772 # 6190 <malloc+0x9d4>
     e94:	00005097          	auipc	ra,0x5
     e98:	86a080e7          	jalr	-1942(ra) # 56fe <printf>
    exit(1);
     e9c:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eac:	30050513          	addi	a0,a0,768 # 61a8 <malloc+0x9ec>
     eb0:	00005097          	auipc	ra,0x5
     eb4:	84e080e7          	jalr	-1970(ra) # 56fe <printf>
    exit(1);
     eb8:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec8:	30450513          	addi	a0,a0,772 # 61c8 <malloc+0xa0c>
     ecc:	00005097          	auipc	ra,0x5
     ed0:	832080e7          	jalr	-1998(ra) # 56fe <printf>
    exit(1);
     ed4:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ee4:	31850513          	addi	a0,a0,792 # 61f8 <malloc+0xa3c>
     ee8:	00005097          	auipc	ra,0x5
     eec:	816080e7          	jalr	-2026(ra) # 56fe <printf>
    exit(1);
     ef0:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f00:	31450513          	addi	a0,a0,788 # 6210 <malloc+0xa54>
     f04:	00004097          	auipc	ra,0x4
     f08:	7fa080e7          	jalr	2042(ra) # 56fe <printf>
    exit(1);
     f0c:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f1c:	31050513          	addi	a0,a0,784 # 6228 <malloc+0xa6c>
     f20:	00004097          	auipc	ra,0x4
     f24:	7de080e7          	jalr	2014(ra) # 56fe <printf>
    exit(1);
     f28:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f38:	31c50513          	addi	a0,a0,796 # 6250 <malloc+0xa94>
     f3c:	00004097          	auipc	ra,0x4
     f40:	7c2080e7          	jalr	1986(ra) # 56fe <printf>
    exit(1);
     f44:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f54:	33050513          	addi	a0,a0,816 # 6280 <malloc+0xac4>
     f58:	00004097          	auipc	ra,0x4
     f5c:	7a6080e7          	jalr	1958(ra) # 56fe <printf>
    exit(1);
     f60:	4505                	li	a0,1
...
0000000000000f6a <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fba:	2eaa0a13          	addi	s4,s4,746 # 62a0 <malloc+0xae4>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    100c:	29850513          	addi	a0,a0,664 # 62a0 <malloc+0xae4>
  ...
  for(i = 0; i < N; i++){
    ...
    107c:	23050513          	addi	a0,a0,560 # 62a8 <malloc+0xaec>
    1080:	00004097          	auipc	ra,0x4
    1084:	67e080e7          	jalr	1662(ra) # 56fe <printf>
    exit(1);
    1088:	4505                	li	a0,1
    ...
    109c:	23050513          	addi	a0,a0,560 # 62c8 <malloc+0xb0c>
    10a0:	00004097          	auipc	ra,0x4
    10a4:	65e080e7          	jalr	1630(ra) # 56fe <printf>
      exit(1);
    10a8:	4505                	li	a0,1
    ...
    10b8:	23450513          	addi	a0,a0,564 # 62e8 <malloc+0xb2c>
    10bc:	00004097          	auipc	ra,0x4
    10c0:	642080e7          	jalr	1602(ra) # 56fe <printf>
      exit(1);
    10c4:	4505                	li	a0,1
...
00000000000010ce <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10ea:	22298993          	addi	s3,s3,546 # 6308 <malloc+0xb4c>
    10ee:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1126:	1f650513          	addi	a0,a0,502 # 6318 <malloc+0xb5c>
    112a:	00004097          	auipc	ra,0x4
    112e:	5d4080e7          	jalr	1492(ra) # 56fe <printf>
      exit(1);
    1132:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1192:	a5298993          	addi	s3,s3,-1454 # 5be0 <malloc+0x424>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	1c078793          	addi	a5,a5,448 # 73d8 <malloc+0x1c1c>
  ...
  if(pid == 0){
    ...
    1252:	de278793          	addi	a5,a5,-542 # 8030 <big.0>
    ...
    1278:	8dc78793          	addi	a5,a5,-1828 # 7b50 <malloc+0x2394>
    ...
    129c:	94850513          	addi	a0,a0,-1720 # 5be0 <malloc+0x424>
    ...
    12b4:	11050513          	addi	a0,a0,272 # 63c0 <malloc+0xc04>
    12b8:	00004097          	auipc	ra,0x4
    12bc:	446080e7          	jalr	1094(ra) # 56fe <printf>
      exit(1);
    12c0:	4505                	li	a0,1
    ...
    12d4:	06850513          	addi	a0,a0,104 # 6338 <malloc+0xb7c>
    12d8:	00004097          	auipc	ra,0x4
    12dc:	426080e7          	jalr	1062(ra) # 56fe <printf>
    exit(1);
    12e0:	4505                	li	a0,1
    ...
    12f4:	06850513          	addi	a0,a0,104 # 6358 <malloc+0xb9c>
    12f8:	00004097          	auipc	ra,0x4
    12fc:	406080e7          	jalr	1030(ra) # 56fe <printf>
    exit(1);
    1300:	4505                	li	a0,1
    ...
    1316:	06650513          	addi	a0,a0,102 # 6378 <malloc+0xbbc>
    131a:	00004097          	auipc	ra,0x4
    131e:	3e4080e7          	jalr	996(ra) # 56fe <printf>
    exit(1);
    1322:	4505                	li	a0,1
    ...
    1336:	06e50513          	addi	a0,a0,110 # 63a0 <malloc+0xbe4>
    133a:	00004097          	auipc	ra,0x4
    133e:	3c4080e7          	jalr	964(ra) # 56fe <printf>
    exit(1);
    1342:	4505                	li	a0,1
    ...
    1350:	4bc50513          	addi	a0,a0,1212 # 6808 <malloc+0x104c>
    1354:	00004097          	auipc	ra,0x4
    1358:	3aa080e7          	jalr	938(ra) # 56fe <printf>
    exit(1);
    135c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    139a:	05250513          	addi	a0,a0,82 # 63e8 <malloc+0xc2c>
    139e:	00004097          	auipc	ra,0x4
    13a2:	360080e7          	jalr	864(ra) # 56fe <printf>
    exit(1);
    13a6:	4505                	li	a0,1
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	87050513          	addi	a0,a0,-1936 # 5c38 <malloc+0x47c>
  ...
  if(pid == 0){
    ...
    13f6:	846a0a13          	addi	s4,s4,-1978 # 5c38 <malloc+0x47c>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	04ea8a93          	addi	s5,s5,78 # 6448 <malloc+0xc8c>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    146e:	fae50513          	addi	a0,a0,-82 # 6418 <malloc+0xc5c>
    1472:	00004097          	auipc	ra,0x4
    1476:	28c080e7          	jalr	652(ra) # 56fe <printf>
    exit(1);
    147a:	4505                	li	a0,1
    ...
    148a:	faa50513          	addi	a0,a0,-86 # 6430 <malloc+0xc74>
    148e:	00004097          	auipc	ra,0x4
    1492:	270080e7          	jalr	624(ra) # 56fe <printf>
        exit(1);
    1496:	4505                	li	a0,1
    ...
    14a8:	fb450513          	addi	a0,a0,-76 # 6458 <malloc+0xc9c>
    14ac:	00004097          	auipc	ra,0x4
    14b0:	252080e7          	jalr	594(ra) # 56fe <printf>
        exit(1);
    14b4:	4505                	li	a0,1
    ...
    14c6:	776a0a13          	addi	s4,s4,1910 # 5c38 <malloc+0x47c>
    int n = write(fd, "xxx", 3);
    14ca:	00005a97          	auipc	s5,0x5
    14ce:	faea8a93          	addi	s5,s5,-82 # 6478 <malloc+0xcbc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1518:	72450513          	addi	a0,a0,1828 # 5c38 <malloc+0x47c>
  ...
  exit(xstatus);
    ...
    1536:	efe50513          	addi	a0,a0,-258 # 6430 <malloc+0xc74>
    153a:	00004097          	auipc	ra,0x4
    153e:	1c4080e7          	jalr	452(ra) # 56fe <printf>
      exit(1);
    1542:	4505                	li	a0,1
    ...
    1554:	f3050513          	addi	a0,a0,-208 # 6480 <malloc+0xcc4>
    1558:	00004097          	auipc	ra,0x4
    155c:	1a6080e7          	jalr	422(ra) # 56fe <printf>
      exit(1);
    1560:	4505                	li	a0,1
...
000000000000156a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    157c:	66878793          	addi	a5,a5,1640 # 5be0 <malloc+0x424>
    1580:	fcf43023          	sd	a5,-64(s0)
    1584:	00005797          	auipc	a5,0x5
    1588:	f1c78793          	addi	a5,a5,-228 # 64a0 <malloc+0xce4>
    158c:	fcf43423          	sd	a5,-56(s0)
    1590:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1594:	00005517          	auipc	a0,0x5
    1598:	f1450513          	addi	a0,a0,-236 # 64a8 <malloc+0xcec>
  ...
  if(pid == 0) {
    ...
    15c6:	ee650513          	addi	a0,a0,-282 # 64a8 <malloc+0xcec>
    ...
    15e2:	eea50513          	addi	a0,a0,-278 # 64c8 <malloc+0xd0c>
    15e6:	00004097          	auipc	ra,0x4
    15ea:	118080e7          	jalr	280(ra) # 56fe <printf>
      exit(1);
    15ee:	4505                	li	a0,1
    ...
    15fe:	e1e50513          	addi	a0,a0,-482 # 6418 <malloc+0xc5c>
    1602:	00004097          	auipc	ra,0x4
    1606:	0fc080e7          	jalr	252(ra) # 56fe <printf>
     exit(1);
    160a:	4505                	li	a0,1
    ...
    161a:	e9a50513          	addi	a0,a0,-358 # 64b0 <malloc+0xcf4>
    161e:	00004097          	auipc	ra,0x4
    1622:	0e0080e7          	jalr	224(ra) # 56fe <printf>
      exit(1);
    1626:	4505                	li	a0,1
    ...
    1638:	5ac50513          	addi	a0,a0,1452 # 5be0 <malloc+0x424>
  ...
  if(xstatus != 0)
    ...
    166c:	e7050513          	addi	a0,a0,-400 # 64d8 <malloc+0xd1c>
    1670:	00004097          	auipc	ra,0x4
    1674:	08e080e7          	jalr	142(ra) # 56fe <printf>
      exit(1);
    1678:	4505                	li	a0,1
    ...
    1688:	e6c50513          	addi	a0,a0,-404 # 64f0 <malloc+0xd34>
    168c:	00004097          	auipc	ra,0x4
    1690:	072080e7          	jalr	114(ra) # 56fe <printf>
    1694:	b7d1                	j	1658 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1696:	4581                	li	a1,0
    1698:	00005517          	auipc	a0,0x5
    169c:	e1050513          	addi	a0,a0,-496 # 64a8 <malloc+0xcec>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c6:	8ae50513          	addi	a0,a0,-1874 # 5f70 <malloc+0x7b4>
    16ca:	00004097          	auipc	ra,0x4
    16ce:	034080e7          	jalr	52(ra) # 56fe <printf>
    exit(1);
    16d2:	4505                	li	a0,1
    ...
    16e2:	d5250513          	addi	a0,a0,-686 # 6430 <malloc+0xc74>
    16e6:	00004097          	auipc	ra,0x4
    16ea:	018080e7          	jalr	24(ra) # 56fe <printf>
    exit(1);
    16ee:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16fc:	db050513          	addi	a0,a0,-592 # 64a8 <malloc+0xcec>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1726:	de650513          	addi	a0,a0,-538 # 6508 <malloc+0xd4c>
    172a:	00004097          	auipc	ra,0x4
    172e:	fd4080e7          	jalr	-44(ra) # 56fe <printf>
    exit(1);
    1732:	4505                	li	a0,1
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e8:	d3c50513          	addi	a0,a0,-708 # 6520 <malloc+0xd64>
    17ec:	00004097          	auipc	ra,0x4
    17f0:	f12080e7          	jalr	-238(ra) # 56fe <printf>
    exit(1);
    17f4:	4505                	li	a0,1
    ...
    1822:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    186e:	cce50513          	addi	a0,a0,-818 # 6538 <malloc+0xd7c>
    1872:	00004097          	auipc	ra,0x4
    1876:	e8c080e7          	jalr	-372(ra) # 56fe <printf>
        exit(1);
    187a:	4505                	li	a0,1
    ...
    188a:	cca50513          	addi	a0,a0,-822 # 6550 <malloc+0xd94>
    188e:	00004097          	auipc	ra,0x4
    1892:	e70080e7          	jalr	-400(ra) # 56fe <printf>
}
    ...
    18bc:	cb050513          	addi	a0,a0,-848 # 6568 <malloc+0xdac>
    18c0:	00004097          	auipc	ra,0x4
    18c4:	e3e080e7          	jalr	-450(ra) # 56fe <printf>
      exit(1);
    18c8:	4505                	li	a0,1
    ...
    18fc:	c9050513          	addi	a0,a0,-880 # 6588 <malloc+0xdcc>
    1900:	00004097          	auipc	ra,0x4
    1904:	dfe080e7          	jalr	-514(ra) # 56fe <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
0000000000001912 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    196e:	aae50513          	addi	a0,a0,-1362 # 6418 <malloc+0xc5c>
    1972:	00004097          	auipc	ra,0x4
    1976:	d8c080e7          	jalr	-628(ra) # 56fe <printf>
      exit(1);
    197a:	4505                	li	a0,1
    ...
    198a:	c1a50513          	addi	a0,a0,-998 # 65a0 <malloc+0xde4>
    198e:	00004097          	auipc	ra,0x4
    1992:	d70080e7          	jalr	-656(ra) # 56fe <printf>
        exit(1);
    1996:	4505                	li	a0,1
    ...
    19a6:	c1650513          	addi	a0,a0,-1002 # 65b8 <malloc+0xdfc>
    19aa:	00004097          	auipc	ra,0x4
    19ae:	d54080e7          	jalr	-684(ra) # 56fe <printf>
        exit(1);
    19b2:	4505                	li	a0,1
...
00000000000019c6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a1e:	9fe50513          	addi	a0,a0,-1538 # 6418 <malloc+0xc5c>
    1a22:	00004097          	auipc	ra,0x4
    1a26:	cdc080e7          	jalr	-804(ra) # 56fe <printf>
      exit(1);
    1a2a:	4505                	li	a0,1
    ...
    1a42:	9da50513          	addi	a0,a0,-1574 # 6418 <malloc+0xc5c>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	cb8080e7          	jalr	-840(ra) # 56fe <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
...
0000000000001a60 <forkfork>:
{
    ...
    1abc:	b2050513          	addi	a0,a0,-1248 # 65d8 <malloc+0xe1c>
    1ac0:	00004097          	auipc	ra,0x4
    1ac4:	c3e080e7          	jalr	-962(ra) # 56fe <printf>
      exit(1);
    1ac8:	4505                	li	a0,1
    ...
    1ace:	8a4080e7          	jalr	-1884(ra) # 536e <exit>
{
    ...
    1b14:	ad850513          	addi	a0,a0,-1320 # 65e8 <malloc+0xe2c>
    1b18:	00004097          	auipc	ra,0x4
    1b1c:	be6080e7          	jalr	-1050(ra) # 56fe <printf>
      exit(1);
    1b20:	4505                	li	a0,1
...
0000000000001b2a <reparent2>:
{
  ...
  exit(0);
    ...
    1b62:	caa50513          	addi	a0,a0,-854 # 6808 <malloc+0x104c>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	b98080e7          	jalr	-1128(ra) # 56fe <printf>
      exit(1);
    1b6e:	4505                	li	a0,1
...
0000000000001b92 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c00:	c0c50513          	addi	a0,a0,-1012 # 6808 <malloc+0x104c>
    1c04:	00004097          	auipc	ra,0x4
    1c08:	afa080e7          	jalr	-1286(ra) # 56fe <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c2c:	88850513          	addi	a0,a0,-1912 # 64b0 <malloc+0xcf4>
    1c30:	00004097          	auipc	ra,0x4
    1c34:	ace080e7          	jalr	-1330(ra) # 56fe <printf>
          exit(1);
    1c38:	4505                	li	a0,1
    ...
    1c9e:	96e50513          	addi	a0,a0,-1682 # 6608 <malloc+0xe4c>
    1ca2:	00004097          	auipc	ra,0x4
    1ca6:	a5c080e7          	jalr	-1444(ra) # 56fe <printf>
            exit(1);
    1caa:	4505                	li	a0,1
    ...
    1cd2:	95250513          	addi	a0,a0,-1710 # 6620 <malloc+0xe64>
    1cd6:	00004097          	auipc	ra,0x4
    1cda:	a28080e7          	jalr	-1496(ra) # 56fe <printf>
        exit(1);
    1cde:	4505                	li	a0,1
    ...
    1d38:	91450513          	addi	a0,a0,-1772 # 6648 <malloc+0xe8c>
    1d3c:	00004097          	auipc	ra,0x4
    1d40:	9c2080e7          	jalr	-1598(ra) # 56fe <printf>
        exit(1);
    1d44:	4505                	li	a0,1
...
0000000000001db8 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	e7c50513          	addi	a0,a0,-388 # 5c50 <malloc+0x494>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e14:	e40a8a93          	addi	s5,s5,-448 # 5c50 <malloc+0x494>
      link("cat", "x");
    1e18:	00005b97          	auipc	s7,0x5
    1e1c:	858b8b93          	addi	s7,s7,-1960 # 6670 <malloc+0xeb4>
    1e20:	a825                	j	1e58 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e22:	85a6                	mv	a1,s1
    1e24:	00004517          	auipc	a0,0x4
    1e28:	5f450513          	addi	a0,a0,1524 # 6418 <malloc+0xc5c>
    1e2c:	00004097          	auipc	ra,0x4
    1e30:	8d2080e7          	jalr	-1838(ra) # 56fe <printf>
    exit(1);
    1e34:	4505                	li	a0,1
...
0000000000001eba <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1eea:	7aa50513          	addi	a0,a0,1962 # 6690 <malloc+0xed4>
    1eee:	00004097          	auipc	ra,0x4
    1ef2:	810080e7          	jalr	-2032(ra) # 56fe <printf>
    exit(1);
    1ef6:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1f4c:	73050513          	addi	a0,a0,1840 # 6678 <malloc+0xebc>
    1f50:	00003097          	auipc	ra,0x3
    1f54:	7ae080e7          	jalr	1966(ra) # 56fe <printf>
    exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f68:	75450513          	addi	a0,a0,1876 # 66b8 <malloc+0xefc>
    1f6c:	00003097          	auipc	ra,0x3
    1f70:	792080e7          	jalr	1938(ra) # 56fe <printf>
      exit(1);
    1f74:	4505                	li	a0,1
    ...
    1f84:	75050513          	addi	a0,a0,1872 # 66d0 <malloc+0xf14>
    1f88:	00003097          	auipc	ra,0x3
    1f8c:	776080e7          	jalr	1910(ra) # 56fe <printf>
    exit(1);
    1f90:	4505                	li	a0,1
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2004:	41850513          	addi	a0,a0,1048 # 6418 <malloc+0xc5c>
    2008:	00003097          	auipc	ra,0x3
    200c:	6f6080e7          	jalr	1782(ra) # 56fe <printf>
      exit(1);
    2010:	4505                	li	a0,1
    ...
    2024:	6c850513          	addi	a0,a0,1736 # 66e8 <malloc+0xf2c>
    2028:	00003097          	auipc	ra,0x3
    202c:	6d6080e7          	jalr	1750(ra) # 56fe <printf>
      exit(1);
    2030:	4505                	li	a0,1
...
0000000000002044 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2054:	6b850513          	addi	a0,a0,1720 # 6708 <malloc+0xf4c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2086:	68650513          	addi	a0,a0,1670 # 6708 <malloc+0xf4c>
  ...
  close(fd);
    ...
    20ac:	e8878793          	addi	a5,a5,-376 # 7f30 <args.1>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f7868693          	addi	a3,a3,-136 # 8028 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20b8:	00004717          	auipc	a4,0x4
    20bc:	66070713          	addi	a4,a4,1632 # 6718 <malloc+0xf5c>
    ...
    2110:	6ec50513          	addi	a0,a0,1772 # 67f8 <malloc+0x103c>
    2114:	00003097          	auipc	ra,0x3
    2118:	5ea080e7          	jalr	1514(ra) # 56fe <printf>
    exit(1);
    211c:	4505                	li	a0,1
    ...
    2134:	6e850513          	addi	a0,a0,1768 # 6818 <malloc+0x105c>
    2138:	00003097          	auipc	ra,0x3
    213c:	5c6080e7          	jalr	1478(ra) # 56fe <printf>
    exit(1);
    2140:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2190:	6ac50513          	addi	a0,a0,1708 # 6838 <malloc+0x107c>
    2194:	00003097          	auipc	ra,0x3
    2198:	56a080e7          	jalr	1386(ra) # 56fe <printf>
    exit(1);
    219c:	4505                	li	a0,1
    ...
    21ac:	27050513          	addi	a0,a0,624 # 6418 <malloc+0xc5c>
    21b0:	00003097          	auipc	ra,0x3
    21b4:	54e080e7          	jalr	1358(ra) # 56fe <printf>
    exit(1);
    21b8:	4505                	li	a0,1
...
00000000000021cc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2246:	19678793          	addi	a5,a5,406 # 73d8 <malloc+0x1c1c>
  ...
  if(ret != -1){
    ...
    2288:	5dc50513          	addi	a0,a0,1500 # 6860 <malloc+0x10a4>
    228c:	00003097          	auipc	ra,0x3
    2290:	472080e7          	jalr	1138(ra) # 56fe <printf>
    exit(1);
    2294:	4505                	li	a0,1
    ...
    22a6:	09650513          	addi	a0,a0,150 # 6338 <malloc+0xb7c>
    22aa:	00003097          	auipc	ra,0x3
    22ae:	454080e7          	jalr	1108(ra) # 56fe <printf>
    exit(1);
    22b2:	4505                	li	a0,1
    ...
    22c4:	09850513          	addi	a0,a0,152 # 6358 <malloc+0xb9c>
    22c8:	00003097          	auipc	ra,0x3
    22cc:	436080e7          	jalr	1078(ra) # 56fe <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e4:	09850513          	addi	a0,a0,152 # 6378 <malloc+0xbbc>
    22e8:	00003097          	auipc	ra,0x3
    22ec:	416080e7          	jalr	1046(ra) # 56fe <printf>
    exit(1);
    22f0:	4505                	li	a0,1
    ...
    2302:	0a250513          	addi	a0,a0,162 # 63a0 <malloc+0xbe4>
    2306:	00003097          	auipc	ra,0x3
    230a:	3f8080e7          	jalr	1016(ra) # 56fe <printf>
    exit(1);
    230e:	4505                	li	a0,1
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2354:	6705                	lui	a4,0x1
      *b = 99;
    2356:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff18a8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    236e:	4fe50513          	addi	a0,a0,1278 # 6868 <malloc+0x10ac>
    2372:	00003097          	auipc	ra,0x3
    2376:	38c080e7          	jalr	908(ra) # 56fe <printf>
    exit(1);
    237a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    23c0:	4cc50513          	addi	a0,a0,1228 # 6888 <malloc+0x10cc>
    23c4:	00003097          	auipc	ra,0x3
    23c8:	33a080e7          	jalr	826(ra) # 56fe <printf>
    exit(1);
    23cc:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2424:	4c850513          	addi	a0,a0,1224 # 68e8 <malloc+0x112c>
    2428:	00003097          	auipc	ra,0x3
    242c:	2d6080e7          	jalr	726(ra) # 56fe <printf>
    exit(1);
    2430:	4505                	li	a0,1
    ...
    2444:	46850513          	addi	a0,a0,1128 # 68a8 <malloc+0x10ec>
    2448:	00003097          	auipc	ra,0x3
    244c:	2b6080e7          	jalr	694(ra) # 56fe <printf>
      exit(1);
    2450:	4505                	li	a0,1
    ...
    2460:	46c50513          	addi	a0,a0,1132 # 68c8 <malloc+0x110c>
    2464:	00003097          	auipc	ra,0x3
    2468:	29a080e7          	jalr	666(ra) # 56fe <printf>
    exit(1);
    246c:	4505                	li	a0,1
...
000000000000249c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    24fe:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f18a7>
  a = sbrk(0);
    2502:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2562:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f18a7>
  ...
  if(c != a){
    ...
    25aa:	36250513          	addi	a0,a0,866 # 6908 <malloc+0x114c>
    25ae:	00003097          	auipc	ra,0x3
    25b2:	150080e7          	jalr	336(ra) # 56fe <printf>
    exit(1);
    25b6:	4505                	li	a0,1
    ...
    25c6:	38e50513          	addi	a0,a0,910 # 6950 <malloc+0x1194>
    25ca:	00003097          	auipc	ra,0x3
    25ce:	134080e7          	jalr	308(ra) # 56fe <printf>
    exit(1);
    25d2:	4505                	li	a0,1
    ...
    25e4:	39050513          	addi	a0,a0,912 # 6970 <malloc+0x11b4>
    25e8:	00003097          	auipc	ra,0x3
    25ec:	116080e7          	jalr	278(ra) # 56fe <printf>
    exit(1);
    25f0:	4505                	li	a0,1
    ...
    2602:	3b250513          	addi	a0,a0,946 # 69b0 <malloc+0x11f4>
    2606:	00003097          	auipc	ra,0x3
    260a:	0f8080e7          	jalr	248(ra) # 56fe <printf>
    exit(1);
    260e:	4505                	li	a0,1
    ...
    261e:	3c650513          	addi	a0,a0,966 # 69e0 <malloc+0x1224>
    2622:	00003097          	auipc	ra,0x3
    2626:	0dc080e7          	jalr	220(ra) # 56fe <printf>
    exit(1);
    262a:	4505                	li	a0,1
    ...
    263c:	3e050513          	addi	a0,a0,992 # 6a18 <malloc+0x125c>
    2640:	00003097          	auipc	ra,0x3
    2644:	0be080e7          	jalr	190(ra) # 56fe <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002652 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2676:	3ce50513          	addi	a0,a0,974 # 6a40 <malloc+0x1284>
    267a:	00003097          	auipc	ra,0x3
    267e:	d34080e7          	jalr	-716(ra) # 53ae <open>
    2682:	84aa                	mv	s1,a0
  unlink("sbrk");
    2684:	00004517          	auipc	a0,0x4
    2688:	3bc50513          	addi	a0,a0,956 # 6a40 <malloc+0x1284>
  ...
  if(pipe((int *) a) != 0){
    ...
    26dc:	37050513          	addi	a0,a0,880 # 6a48 <malloc+0x128c>
    26e0:	00003097          	auipc	ra,0x3
    26e4:	01e080e7          	jalr	30(ra) # 56fe <printf>
    exit(1);
    26e8:	4505                	li	a0,1
    ...
    26f8:	36c50513          	addi	a0,a0,876 # 6a60 <malloc+0x12a4>
    26fc:	00003097          	auipc	ra,0x3
    2700:	002080e7          	jalr	2(ra) # 56fe <printf>
    exit(1);
    2704:	4505                	li	a0,1
    ...
    2714:	e1050513          	addi	a0,a0,-496 # 6520 <malloc+0xd64>
    2718:	00003097          	auipc	ra,0x3
    271c:	fe6080e7          	jalr	-26(ra) # 56fe <printf>
    exit(1);
    2720:	4505                	li	a0,1
...
000000000000272a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    273e:	33e50513          	addi	a0,a0,830 # 6a78 <malloc+0x12bc>
  ...
  close(fd);
    ...
    2786:	cae50513          	addi	a0,a0,-850 # 6430 <malloc+0xc74>
    278a:	00003097          	auipc	ra,0x3
    278e:	f74080e7          	jalr	-140(ra) # 56fe <printf>
    exit(1);
    2792:	4505                	li	a0,1
...
000000000000279c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d4:	03850513          	addi	a0,a0,56 # 6808 <malloc+0x104c>
    27d8:	00003097          	auipc	ra,0x3
    27dc:	f26080e7          	jalr	-218(ra) # 56fe <printf>
    exit(1);
    27e0:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    282a:	fe250513          	addi	a0,a0,-30 # 6808 <malloc+0x104c>
    282e:	00003097          	auipc	ra,0x3
    2832:	ed0080e7          	jalr	-304(ra) # 56fe <printf>
    exit(1);
    2836:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    288a:	f8250513          	addi	a0,a0,-126 # 6808 <malloc+0x104c>
    288e:	00003097          	auipc	ra,0x3
    2892:	e70080e7          	jalr	-400(ra) # 56fe <printf>
    exit(1);
    2896:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f6:	f1650513          	addi	a0,a0,-234 # 6808 <malloc+0x104c>
    28fa:	00003097          	auipc	ra,0x3
    28fe:	e04080e7          	jalr	-508(ra) # 56fe <printf>
      exit(1);
    2902:	4505                	li	a0,1
    ...
    294a:	29a50513          	addi	a0,a0,666 # 5be0 <malloc+0x424>
    294e:	faa43c23          	sd	a0,-72(s0)
    2952:	00003797          	auipc	a5,0x3
    2956:	2fe78793          	addi	a5,a5,766 # 5c50 <malloc+0x494>
...
0000000000002978 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2988:	2cc50513          	addi	a0,a0,716 # 6c50 <malloc+0x1494>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    299a:	11250513          	addi	a0,a0,274 # 6aa8 <malloc+0x12ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29b0:	15450513          	addi	a0,a0,340 # 6b00 <malloc+0x1344>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29ce:	1ae50513          	addi	a0,a0,430 # 6b78 <malloc+0x13bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29ea:	20250513          	addi	a0,a0,514 # 6be8 <malloc+0x142c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29fc:	24850513          	addi	a0,a0,584 # 6c40 <malloc+0x1484>
  ...
  unlink("12345678901234");
    ...
    2a7a:	00a50513          	addi	a0,a0,10 # 6a80 <malloc+0x12c4>
    2a7e:	00003097          	auipc	ra,0x3
    2a82:	c80080e7          	jalr	-896(ra) # 56fe <printf>
    exit(1);
    2a86:	4505                	li	a0,1
    ...
    2a96:	03650513          	addi	a0,a0,54 # 6ac8 <malloc+0x130c>
    2a9a:	00003097          	auipc	ra,0x3
    2a9e:	c64080e7          	jalr	-924(ra) # 56fe <printf>
    exit(1);
    2aa2:	4505                	li	a0,1
    ...
    2ab2:	08250513          	addi	a0,a0,130 # 6b30 <malloc+0x1374>
    2ab6:	00003097          	auipc	ra,0x3
    2aba:	c48080e7          	jalr	-952(ra) # 56fe <printf>
    exit(1);
    2abe:	4505                	li	a0,1
    ...
    2ace:	0de50513          	addi	a0,a0,222 # 6ba8 <malloc+0x13ec>
    2ad2:	00003097          	auipc	ra,0x3
    2ad6:	c2c080e7          	jalr	-980(ra) # 56fe <printf>
    exit(1);
    2ada:	4505                	li	a0,1
    ...
    2aea:	12250513          	addi	a0,a0,290 # 6c08 <malloc+0x144c>
    2aee:	00003097          	auipc	ra,0x3
    2af2:	c10080e7          	jalr	-1008(ra) # 56fe <printf>
    exit(1);
    2af6:	4505                	li	a0,1
    ...
    2b06:	15e50513          	addi	a0,a0,350 # 6c60 <malloc+0x14a4>
    2b0a:	00003097          	auipc	ra,0x3
    2b0e:	bf4080e7          	jalr	-1036(ra) # 56fe <printf>
    exit(1);
    2b12:	4505                	li	a0,1
...
0000000000002b1c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b2c:	17050513          	addi	a0,a0,368 # 6c98 <malloc+0x14dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b40:	15c50513          	addi	a0,a0,348 # 6c98 <malloc+0x14dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b54:	18850513          	addi	a0,a0,392 # 6cd8 <malloc+0x151c>
  ...
  if(chdir("/") < 0){
    ...
    2b68:	1a450513          	addi	a0,a0,420 # 6d08 <malloc+0x154c>
    ...
    2b88:	11c50513          	addi	a0,a0,284 # 6ca0 <malloc+0x14e4>
    2b8c:	00003097          	auipc	ra,0x3
    2b90:	b72080e7          	jalr	-1166(ra) # 56fe <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba4:	11850513          	addi	a0,a0,280 # 6cb8 <malloc+0x14fc>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	b56080e7          	jalr	-1194(ra) # 56fe <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    ...
    2bc0:	12c50513          	addi	a0,a0,300 # 6ce8 <malloc+0x152c>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	b3a080e7          	jalr	-1222(ra) # 56fe <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    ...
    2bdc:	13850513          	addi	a0,a0,312 # 6d10 <malloc+0x1554>
    2be0:	00003097          	auipc	ra,0x3
    2be4:	b1e080e7          	jalr	-1250(ra) # 56fe <printf>
    exit(1);
    2be8:	4505                	li	a0,1
...
0000000000002bf2 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c10:	08c50513          	addi	a0,a0,140 # 6c98 <malloc+0x14dc>
    ...
    2c24:	07850513          	addi	a0,a0,120 # 6c98 <malloc+0x14dc>
    ...
    2c38:	0a450513          	addi	a0,a0,164 # 6cd8 <malloc+0x151c>
    ...
    2c58:	7c450513          	addi	a0,a0,1988 # 6418 <malloc+0xc5c>
    2c5c:	00003097          	auipc	ra,0x3
    2c60:	aa2080e7          	jalr	-1374(ra) # 56fe <printf>
    exit(1);
    2c64:	4505                	li	a0,1
    ...
    2c74:	03050513          	addi	a0,a0,48 # 6ca0 <malloc+0x14e4>
    2c78:	00003097          	auipc	ra,0x3
    2c7c:	a86080e7          	jalr	-1402(ra) # 56fe <printf>
      exit(1);
    2c80:	4505                	li	a0,1
    ...
    2c90:	09c50513          	addi	a0,a0,156 # 6d28 <malloc+0x156c>
    2c94:	00003097          	auipc	ra,0x3
    2c98:	a6a080e7          	jalr	-1430(ra) # 56fe <printf>
      exit(1);
    2c9c:	4505                	li	a0,1
    ...
    2cac:	04050513          	addi	a0,a0,64 # 6ce8 <malloc+0x152c>
    2cb0:	00003097          	auipc	ra,0x3
    2cb4:	a4e080e7          	jalr	-1458(ra) # 56fe <printf>
      exit(1);
    2cb8:	4505                	li	a0,1
...
0000000000002cda <subdir>:
{
  ...
  unlink("ff");
    ...
    2cec:	18850513          	addi	a0,a0,392 # 6e70 <malloc+0x16b4>
    2cf0:	00002097          	auipc	ra,0x2
    2cf4:	6ce080e7          	jalr	1742(ra) # 53be <unlink>
  if(mkdir("dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	04850513          	addi	a0,a0,72 # 6d40 <malloc+0x1584>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d14:	05050513          	addi	a0,a0,80 # 6d60 <malloc+0x15a4>
  ...
  write(fd, "ff", 2);
    ...
    2d2c:	14858593          	addi	a1,a1,328 # 6e70 <malloc+0x16b4>
  ...
  if(unlink("dd") >= 0){
    ...
    2d46:	ffe50513          	addi	a0,a0,-2 # 6d40 <malloc+0x1584>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d5a:	06250513          	addi	a0,a0,98 # 6db8 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d72:	07250513          	addi	a0,a0,114 # 6de0 <malloc+0x1624>
  ...
  write(fd, "FF", 2);
    ...
    2d8a:	08a58593          	addi	a1,a1,138 # 6e10 <malloc+0x1654>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da6:	07650513          	addi	a0,a0,118 # 6e18 <malloc+0x165c>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dbe:	98e58593          	addi	a1,a1,-1650 # b748 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd4:	97874703          	lbu	a4,-1672(a4) # b748 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2dee:	07e58593          	addi	a1,a1,126 # 6e68 <malloc+0x16ac>
    2df2:	00004517          	auipc	a0,0x4
    2df6:	fee50513          	addi	a0,a0,-18 # 6de0 <malloc+0x1624>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e0a:	fda50513          	addi	a0,a0,-38 # 6de0 <malloc+0x1624>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e20:	fc450513          	addi	a0,a0,-60 # 6de0 <malloc+0x1624>
  ...
  if(chdir("dd") != 0){
    ...
    2e34:	f1050513          	addi	a0,a0,-240 # 6d40 <malloc+0x1584>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e48:	0bc50513          	addi	a0,a0,188 # 6f00 <malloc+0x1744>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e5c:	0d850513          	addi	a0,a0,216 # 6f30 <malloc+0x1774>
  ...
  if(chdir("./..") != 0){
    ...
    2e70:	0f450513          	addi	a0,a0,244 # 6f60 <malloc+0x17a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e86:	fe650513          	addi	a0,a0,-26 # 6e68 <malloc+0x16ac>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2e9e:	8ae58593          	addi	a1,a1,-1874 # b748 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ec0:	f2450513          	addi	a0,a0,-220 # 6de0 <malloc+0x1624>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ed8:	11c50513          	addi	a0,a0,284 # 6ff0 <malloc+0x1834>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ef0:	13450513          	addi	a0,a0,308 # 7020 <malloc+0x1864>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f08:	e3c50513          	addi	a0,a0,-452 # 6d40 <malloc+0x1584>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f1e:	e2650513          	addi	a0,a0,-474 # 6d40 <malloc+0x1584>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f34:	e1050513          	addi	a0,a0,-496 # 6d40 <malloc+0x1584>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f48:	16c58593          	addi	a1,a1,364 # 70b0 <malloc+0x18f4>
    2f4c:	00004517          	auipc	a0,0x4
    2f50:	0a450513          	addi	a0,a0,164 # 6ff0 <malloc+0x1834>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f64:	15058593          	addi	a1,a1,336 # 70b0 <malloc+0x18f4>
    2f68:	00004517          	auipc	a0,0x4
    2f6c:	0b850513          	addi	a0,a0,184 # 7020 <malloc+0x1864>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f80:	eec58593          	addi	a1,a1,-276 # 6e68 <malloc+0x16ac>
    2f84:	00004517          	auipc	a0,0x4
    2f88:	ddc50513          	addi	a0,a0,-548 # 6d60 <malloc+0x15a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f9c:	05850513          	addi	a0,a0,88 # 6ff0 <malloc+0x1834>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fb0:	07450513          	addi	a0,a0,116 # 7020 <malloc+0x1864>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc4:	ea850513          	addi	a0,a0,-344 # 6e68 <malloc+0x16ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fd8:	04c50513          	addi	a0,a0,76 # 7020 <malloc+0x1864>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fec:	00850513          	addi	a0,a0,8 # 6ff0 <malloc+0x1834>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3000:	d6450513          	addi	a0,a0,-668 # 6d60 <malloc+0x15a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3014:	1f050513          	addi	a0,a0,496 # 7200 <malloc+0x1a44>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3028:	e4450513          	addi	a0,a0,-444 # 6e68 <malloc+0x16ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    303c:	d2850513          	addi	a0,a0,-728 # 6d60 <malloc+0x15a4>
  ...
  if(unlink("dd") == 0){
    ...
    3050:	cf450513          	addi	a0,a0,-780 # 6d40 <malloc+0x1584>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3064:	21050513          	addi	a0,a0,528 # 7270 <malloc+0x1ab4>
  ...
  if(unlink("dd") < 0){
    ...
    3078:	ccc50513          	addi	a0,a0,-820 # 6d40 <malloc+0x1584>
    ...
    309a:	cb250513          	addi	a0,a0,-846 # 6d48 <malloc+0x158c>
    309e:	00002097          	auipc	ra,0x2
    30a2:	660080e7          	jalr	1632(ra) # 56fe <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b6:	cb650513          	addi	a0,a0,-842 # 6d68 <malloc+0x15ac>
    30ba:	00002097          	auipc	ra,0x2
    30be:	644080e7          	jalr	1604(ra) # 56fe <printf>
    exit(1);
    30c2:	4505                	li	a0,1
    ...
    30d2:	cba50513          	addi	a0,a0,-838 # 6d88 <malloc+0x15cc>
    30d6:	00002097          	auipc	ra,0x2
    30da:	628080e7          	jalr	1576(ra) # 56fe <printf>
    exit(1);
    30de:	4505                	li	a0,1
    ...
    30ee:	cd650513          	addi	a0,a0,-810 # 6dc0 <malloc+0x1604>
    30f2:	00002097          	auipc	ra,0x2
    30f6:	60c080e7          	jalr	1548(ra) # 56fe <printf>
    exit(1);
    30fa:	4505                	li	a0,1
    ...
    310a:	cea50513          	addi	a0,a0,-790 # 6df0 <malloc+0x1634>
    310e:	00002097          	auipc	ra,0x2
    3112:	5f0080e7          	jalr	1520(ra) # 56fe <printf>
    exit(1);
    3116:	4505                	li	a0,1
    ...
    3126:	d0650513          	addi	a0,a0,-762 # 6e28 <malloc+0x166c>
    312a:	00002097          	auipc	ra,0x2
    312e:	5d4080e7          	jalr	1492(ra) # 56fe <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    3142:	d0a50513          	addi	a0,a0,-758 # 6e48 <malloc+0x168c>
    3146:	00002097          	auipc	ra,0x2
    314a:	5b8080e7          	jalr	1464(ra) # 56fe <printf>
    exit(1);
    314e:	4505                	li	a0,1
    ...
    315e:	d1e50513          	addi	a0,a0,-738 # 6e78 <malloc+0x16bc>
    3162:	00002097          	auipc	ra,0x2
    3166:	59c080e7          	jalr	1436(ra) # 56fe <printf>
    exit(1);
    316a:	4505                	li	a0,1
    ...
    317a:	d2a50513          	addi	a0,a0,-726 # 6ea0 <malloc+0x16e4>
    317e:	00002097          	auipc	ra,0x2
    3182:	580080e7          	jalr	1408(ra) # 56fe <printf>
    exit(1);
    3186:	4505                	li	a0,1
    ...
    3196:	d2e50513          	addi	a0,a0,-722 # 6ec0 <malloc+0x1704>
    319a:	00002097          	auipc	ra,0x2
    319e:	564080e7          	jalr	1380(ra) # 56fe <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	d3a50513          	addi	a0,a0,-710 # 6ee8 <malloc+0x172c>
    31b6:	00002097          	auipc	ra,0x2
    31ba:	548080e7          	jalr	1352(ra) # 56fe <printf>
    exit(1);
    31be:	4505                	li	a0,1
    ...
    31ce:	d4650513          	addi	a0,a0,-698 # 6f10 <malloc+0x1754>
    31d2:	00002097          	auipc	ra,0x2
    31d6:	52c080e7          	jalr	1324(ra) # 56fe <printf>
    exit(1);
    31da:	4505                	li	a0,1
    ...
    31ea:	d5a50513          	addi	a0,a0,-678 # 6f40 <malloc+0x1784>
    31ee:	00002097          	auipc	ra,0x2
    31f2:	510080e7          	jalr	1296(ra) # 56fe <printf>
    exit(1);
    31f6:	4505                	li	a0,1
    ...
    3206:	d6650513          	addi	a0,a0,-666 # 6f68 <malloc+0x17ac>
    320a:	00002097          	auipc	ra,0x2
    320e:	4f4080e7          	jalr	1268(ra) # 56fe <printf>
    exit(1);
    3212:	4505                	li	a0,1
    ...
    3222:	d6250513          	addi	a0,a0,-670 # 6f80 <malloc+0x17c4>
    3226:	00002097          	auipc	ra,0x2
    322a:	4d8080e7          	jalr	1240(ra) # 56fe <printf>
    exit(1);
    322e:	4505                	li	a0,1
    ...
    323e:	d6650513          	addi	a0,a0,-666 # 6fa0 <malloc+0x17e4>
    3242:	00002097          	auipc	ra,0x2
    3246:	4bc080e7          	jalr	1212(ra) # 56fe <printf>
    exit(1);
    324a:	4505                	li	a0,1
    ...
    325a:	d6a50513          	addi	a0,a0,-662 # 6fc0 <malloc+0x1804>
    325e:	00002097          	auipc	ra,0x2
    3262:	4a0080e7          	jalr	1184(ra) # 56fe <printf>
    exit(1);
    3266:	4505                	li	a0,1
    ...
    3276:	d8e50513          	addi	a0,a0,-626 # 7000 <malloc+0x1844>
    327a:	00002097          	auipc	ra,0x2
    327e:	484080e7          	jalr	1156(ra) # 56fe <printf>
    exit(1);
    3282:	4505                	li	a0,1
    ...
    3292:	da250513          	addi	a0,a0,-606 # 7030 <malloc+0x1874>
    3296:	00002097          	auipc	ra,0x2
    329a:	468080e7          	jalr	1128(ra) # 56fe <printf>
    exit(1);
    329e:	4505                	li	a0,1
    ...
    32ae:	da650513          	addi	a0,a0,-602 # 7050 <malloc+0x1894>
    32b2:	00002097          	auipc	ra,0x2
    32b6:	44c080e7          	jalr	1100(ra) # 56fe <printf>
    exit(1);
    32ba:	4505                	li	a0,1
    ...
    32ca:	daa50513          	addi	a0,a0,-598 # 7070 <malloc+0x18b4>
    32ce:	00002097          	auipc	ra,0x2
    32d2:	430080e7          	jalr	1072(ra) # 56fe <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e6:	dae50513          	addi	a0,a0,-594 # 7090 <malloc+0x18d4>
    32ea:	00002097          	auipc	ra,0x2
    32ee:	414080e7          	jalr	1044(ra) # 56fe <printf>
    exit(1);
    32f2:	4505                	li	a0,1
    ...
    3302:	dc250513          	addi	a0,a0,-574 # 70c0 <malloc+0x1904>
    3306:	00002097          	auipc	ra,0x2
    330a:	3f8080e7          	jalr	1016(ra) # 56fe <printf>
    exit(1);
    330e:	4505                	li	a0,1
    ...
    331e:	dce50513          	addi	a0,a0,-562 # 70e8 <malloc+0x192c>
    3322:	00002097          	auipc	ra,0x2
    3326:	3dc080e7          	jalr	988(ra) # 56fe <printf>
    exit(1);
    332a:	4505                	li	a0,1
    ...
    333a:	dda50513          	addi	a0,a0,-550 # 7110 <malloc+0x1954>
    333e:	00002097          	auipc	ra,0x2
    3342:	3c0080e7          	jalr	960(ra) # 56fe <printf>
    exit(1);
    3346:	4505                	li	a0,1
    ...
    3356:	de650513          	addi	a0,a0,-538 # 7138 <malloc+0x197c>
    335a:	00002097          	auipc	ra,0x2
    335e:	3a4080e7          	jalr	932(ra) # 56fe <printf>
    exit(1);
    3362:	4505                	li	a0,1
    ...
    3372:	dea50513          	addi	a0,a0,-534 # 7158 <malloc+0x199c>
    3376:	00002097          	auipc	ra,0x2
    337a:	388080e7          	jalr	904(ra) # 56fe <printf>
    exit(1);
    337e:	4505                	li	a0,1
    ...
    338e:	dee50513          	addi	a0,a0,-530 # 7178 <malloc+0x19bc>
    3392:	00002097          	auipc	ra,0x2
    3396:	36c080e7          	jalr	876(ra) # 56fe <printf>
    exit(1);
    339a:	4505                	li	a0,1
    ...
    33aa:	dfa50513          	addi	a0,a0,-518 # 71a0 <malloc+0x19e4>
    33ae:	00002097          	auipc	ra,0x2
    33b2:	350080e7          	jalr	848(ra) # 56fe <printf>
    exit(1);
    33b6:	4505                	li	a0,1
    ...
    33c6:	dfe50513          	addi	a0,a0,-514 # 71c0 <malloc+0x1a04>
    33ca:	00002097          	auipc	ra,0x2
    33ce:	334080e7          	jalr	820(ra) # 56fe <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33e2:	e0250513          	addi	a0,a0,-510 # 71e0 <malloc+0x1a24>
    33e6:	00002097          	auipc	ra,0x2
    33ea:	318080e7          	jalr	792(ra) # 56fe <printf>
    exit(1);
    33ee:	4505                	li	a0,1
    ...
    33fe:	e0e50513          	addi	a0,a0,-498 # 7208 <malloc+0x1a4c>
    3402:	00002097          	auipc	ra,0x2
    3406:	2fc080e7          	jalr	764(ra) # 56fe <printf>
    exit(1);
    340a:	4505                	li	a0,1
    ...
    341a:	a8a50513          	addi	a0,a0,-1398 # 6ea0 <malloc+0x16e4>
    341e:	00002097          	auipc	ra,0x2
    3422:	2e0080e7          	jalr	736(ra) # 56fe <printf>
    exit(1);
    3426:	4505                	li	a0,1
    ...
    3436:	df650513          	addi	a0,a0,-522 # 7228 <malloc+0x1a6c>
    343a:	00002097          	auipc	ra,0x2
    343e:	2c4080e7          	jalr	708(ra) # 56fe <printf>
    exit(1);
    3442:	4505                	li	a0,1
    ...
    3452:	dfa50513          	addi	a0,a0,-518 # 7248 <malloc+0x1a8c>
    3456:	00002097          	auipc	ra,0x2
    345a:	2a8080e7          	jalr	680(ra) # 56fe <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346e:	e0e50513          	addi	a0,a0,-498 # 7278 <malloc+0x1abc>
    3472:	00002097          	auipc	ra,0x2
    3476:	28c080e7          	jalr	652(ra) # 56fe <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	e1250513          	addi	a0,a0,-494 # 7298 <malloc+0x1adc>
    348e:	00002097          	auipc	ra,0x2
    3492:	270080e7          	jalr	624(ra) # 56fe <printf>
    exit(1);
    3496:	4505                	li	a0,1
...
00000000000034a0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34b0:	e0450513          	addi	a0,a0,-508 # 72b0 <malloc+0x1af4>
  ...
  if(chdir("dots") != 0){
    ...
    34c2:	df250513          	addi	a0,a0,-526 # 72b0 <malloc+0x1af4>
  ...
  if(unlink(".") == 0){
    ...
    34d4:	da850513          	addi	a0,a0,-600 # 6278 <malloc+0xabc>
  ...
  if(unlink("..") == 0){
    ...
    34e6:	e1e50513          	addi	a0,a0,-482 # 7300 <malloc+0x1b44>
  ...
  if(chdir("/") != 0){
    ...
    34f8:	81450513          	addi	a0,a0,-2028 # 6d08 <malloc+0x154c>
  ...
  if(unlink("dots/.") == 0){
    ...
    350a:	e1a50513          	addi	a0,a0,-486 # 7320 <malloc+0x1b64>
  ...
  if(unlink("dots/..") == 0){
    ...
    351c:	e3050513          	addi	a0,a0,-464 # 7348 <malloc+0x1b8c>
  ...
  if(unlink("dots") != 0){
    ...
    352e:	d8650513          	addi	a0,a0,-634 # 72b0 <malloc+0x1af4>
    ...
    354c:	d7050513          	addi	a0,a0,-656 # 72b8 <malloc+0x1afc>
    3550:	00002097          	auipc	ra,0x2
    3554:	1ae080e7          	jalr	430(ra) # 56fe <printf>
    exit(1);
    3558:	4505                	li	a0,1
    ...
    3568:	d6c50513          	addi	a0,a0,-660 # 72d0 <malloc+0x1b14>
    356c:	00002097          	auipc	ra,0x2
    3570:	192080e7          	jalr	402(ra) # 56fe <printf>
    exit(1);
    3574:	4505                	li	a0,1
    ...
    3584:	d6850513          	addi	a0,a0,-664 # 72e8 <malloc+0x1b2c>
    3588:	00002097          	auipc	ra,0x2
    358c:	176080e7          	jalr	374(ra) # 56fe <printf>
    exit(1);
    3590:	4505                	li	a0,1
    ...
    35a0:	d6c50513          	addi	a0,a0,-660 # 7308 <malloc+0x1b4c>
    35a4:	00002097          	auipc	ra,0x2
    35a8:	15a080e7          	jalr	346(ra) # 56fe <printf>
    exit(1);
    35ac:	4505                	li	a0,1
    ...
    35bc:	75850513          	addi	a0,a0,1880 # 6d10 <malloc+0x1554>
    35c0:	00002097          	auipc	ra,0x2
    35c4:	13e080e7          	jalr	318(ra) # 56fe <printf>
    exit(1);
    35c8:	4505                	li	a0,1
    ...
    35d8:	d5450513          	addi	a0,a0,-684 # 7328 <malloc+0x1b6c>
    35dc:	00002097          	auipc	ra,0x2
    35e0:	122080e7          	jalr	290(ra) # 56fe <printf>
    exit(1);
    35e4:	4505                	li	a0,1
    ...
    35f4:	d6050513          	addi	a0,a0,-672 # 7350 <malloc+0x1b94>
    35f8:	00002097          	auipc	ra,0x2
    35fc:	106080e7          	jalr	262(ra) # 56fe <printf>
    exit(1);
    3600:	4505                	li	a0,1
    ...
    3610:	d6450513          	addi	a0,a0,-668 # 7370 <malloc+0x1bb4>
    3614:	00002097          	auipc	ra,0x2
    3618:	0ea080e7          	jalr	234(ra) # 56fe <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003626 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    363c:	54850513          	addi	a0,a0,1352 # 5b80 <malloc+0x3c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    3658:	52c50513          	addi	a0,a0,1324 # 5b80 <malloc+0x3c4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    366c:	d6850513          	addi	a0,a0,-664 # 73d0 <malloc+0x1c14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3684:	d5050513          	addi	a0,a0,-688 # 73d0 <malloc+0x1c14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3698:	d3c50513          	addi	a0,a0,-708 # 73d0 <malloc+0x1c14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36ac:	d2850513          	addi	a0,a0,-728 # 73d0 <malloc+0x1c14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36c0:	d1458593          	addi	a1,a1,-748 # 73d0 <malloc+0x1c14>
    36c4:	00002517          	auipc	a0,0x2
    36c8:	6b450513          	addi	a0,a0,1716 # 5d78 <malloc+0x5bc>
  ...
  if(unlink("dirfile") != 0){
    ...
    36dc:	4a850513          	addi	a0,a0,1192 # 5b80 <malloc+0x3c4>
  ...
  fd = open(".", O_RDWR);
    ...
    36f2:	b8a50513          	addi	a0,a0,-1142 # 6278 <malloc+0xabc>
  ...
  fd = open(".", 0);
    ...
    3708:	b7450513          	addi	a0,a0,-1164 # 6278 <malloc+0xabc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    371c:	53858593          	addi	a1,a1,1336 # 5c50 <malloc+0x494>
  ...
  close(fd);
    ...
    3748:	c4c50513          	addi	a0,a0,-948 # 7390 <malloc+0x1bd4>
    374c:	00002097          	auipc	ra,0x2
    3750:	fb2080e7          	jalr	-78(ra) # 56fe <printf>
    exit(1);
    3754:	4505                	li	a0,1
    ...
    3764:	c5050513          	addi	a0,a0,-944 # 73b0 <malloc+0x1bf4>
    3768:	00002097          	auipc	ra,0x2
    376c:	f96080e7          	jalr	-106(ra) # 56fe <printf>
    exit(1);
    3770:	4505                	li	a0,1
    ...
    3780:	c6450513          	addi	a0,a0,-924 # 73e0 <malloc+0x1c24>
    3784:	00002097          	auipc	ra,0x2
    3788:	f7a080e7          	jalr	-134(ra) # 56fe <printf>
    exit(1);
    378c:	4505                	li	a0,1
    ...
    379c:	c4850513          	addi	a0,a0,-952 # 73e0 <malloc+0x1c24>
    37a0:	00002097          	auipc	ra,0x2
    37a4:	f5e080e7          	jalr	-162(ra) # 56fe <printf>
    exit(1);
    37a8:	4505                	li	a0,1
    ...
    37b8:	c5450513          	addi	a0,a0,-940 # 7408 <malloc+0x1c4c>
    37bc:	00002097          	auipc	ra,0x2
    37c0:	f42080e7          	jalr	-190(ra) # 56fe <printf>
    exit(1);
    37c4:	4505                	li	a0,1
    ...
    37d4:	c6050513          	addi	a0,a0,-928 # 7430 <malloc+0x1c74>
    37d8:	00002097          	auipc	ra,0x2
    37dc:	f26080e7          	jalr	-218(ra) # 56fe <printf>
    exit(1);
    37e0:	4505                	li	a0,1
    ...
    37f0:	c6c50513          	addi	a0,a0,-916 # 7458 <malloc+0x1c9c>
    37f4:	00002097          	auipc	ra,0x2
    37f8:	f0a080e7          	jalr	-246(ra) # 56fe <printf>
    exit(1);
    37fc:	4505                	li	a0,1
    ...
    380c:	c7850513          	addi	a0,a0,-904 # 7480 <malloc+0x1cc4>
    3810:	00002097          	auipc	ra,0x2
    3814:	eee080e7          	jalr	-274(ra) # 56fe <printf>
    exit(1);
    3818:	4505                	li	a0,1
    ...
    3828:	c7c50513          	addi	a0,a0,-900 # 74a0 <malloc+0x1ce4>
    382c:	00002097          	auipc	ra,0x2
    3830:	ed2080e7          	jalr	-302(ra) # 56fe <printf>
    exit(1);
    3834:	4505                	li	a0,1
    ...
    3844:	c8850513          	addi	a0,a0,-888 # 74c8 <malloc+0x1d0c>
    3848:	00002097          	auipc	ra,0x2
    384c:	eb6080e7          	jalr	-330(ra) # 56fe <printf>
    exit(1);
    3850:	4505                	li	a0,1
...
000000000000385a <iref>:
{
    ...
    3878:	c6ca0a13          	addi	s4,s4,-916 # 74e0 <malloc+0x1d24>
    mkdir("");
    387c:	00003497          	auipc	s1,0x3
    3880:	76c48493          	addi	s1,s1,1900 # 6fe8 <malloc+0x182c>
    link("README", "");
    3884:	00002a97          	auipc	s5,0x2
    3888:	4f4a8a93          	addi	s5,s5,1268 # 5d78 <malloc+0x5bc>
    fd = open("xx", O_CREATE);
    388c:	00004997          	auipc	s3,0x4
    3890:	b4c98993          	addi	s3,s3,-1204 # 73d8 <malloc+0x1c1c>
    3894:	a891                	j	38e8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3896:	85da                	mv	a1,s6
    3898:	00004517          	auipc	a0,0x4
    389c:	c5050513          	addi	a0,a0,-944 # 74e8 <malloc+0x1d2c>
    38a0:	00002097          	auipc	ra,0x2
    38a4:	e5e080e7          	jalr	-418(ra) # 56fe <printf>
      exit(1);
    38a8:	4505                	li	a0,1
    ...
    38b8:	c4c50513          	addi	a0,a0,-948 # 7500 <malloc+0x1d44>
    38bc:	00002097          	auipc	ra,0x2
    38c0:	e42080e7          	jalr	-446(ra) # 56fe <printf>
      exit(1);
    38c4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    394c:	9b898993          	addi	s3,s3,-1608 # 7300 <malloc+0x1b44>
    unlink("irefd");
    3950:	00004917          	auipc	s2,0x4
    3954:	b9090913          	addi	s2,s2,-1136 # 74e0 <malloc+0x1d24>
    chdir("..");
    3958:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3974:	39850513          	addi	a0,a0,920 # 6d08 <malloc+0x154c>
...
0000000000003994 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a4:	b7850513          	addi	a0,a0,-1160 # 7518 <malloc+0x1d5c>
  ...
  if(pid == 0){
    ...
    39c8:	b5450513          	addi	a0,a0,-1196 # 7518 <malloc+0x1d5c>
    ...
    39de:	b5e50513          	addi	a0,a0,-1186 # 7538 <malloc+0x1d7c>
    39e2:	00002097          	auipc	ra,0x2
    39e6:	d1c080e7          	jalr	-740(ra) # 56fe <printf>
      exit(1);
    39ea:	4505                	li	a0,1
    ...
    39fa:	b2a50513          	addi	a0,a0,-1238 # 7520 <malloc+0x1d64>
    39fe:	00002097          	auipc	ra,0x2
    3a02:	d00080e7          	jalr	-768(ra) # 56fe <printf>
    exit(1);
    3a06:	4505                	li	a0,1
    ...
    3a16:	a0650513          	addi	a0,a0,-1530 # 6418 <malloc+0xc5c>
    3a1a:	00002097          	auipc	ra,0x2
    3a1e:	ce4080e7          	jalr	-796(ra) # 56fe <printf>
    exit(1);
    3a22:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3a44:	ad850513          	addi	a0,a0,-1320 # 7518 <malloc+0x1d5c>
    ...
    3a58:	bb450513          	addi	a0,a0,-1100 # 6608 <malloc+0xe4c>
    3a5c:	00002097          	auipc	ra,0x2
    3a60:	ca2080e7          	jalr	-862(ra) # 56fe <printf>
    exit(1);
    3a64:	4505                	li	a0,1
...
0000000000003a86 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a96:	ace50513          	addi	a0,a0,-1330 # 7560 <malloc+0x1da4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ac2:	aa250513          	addi	a0,a0,-1374 # 7560 <malloc+0x1da4>
  ...
  sleep(10); // one second
    ...
    3afa:	ae250513          	addi	a0,a0,-1310 # 65d8 <malloc+0xe1c>
    3afe:	00002097          	auipc	ra,0x2
    3b02:	c00080e7          	jalr	-1024(ra) # 56fe <printf>
    exit(1);
    3b06:	4505                	li	a0,1
    ...
    3b14:	a5048493          	addi	s1,s1,-1456 # 7560 <malloc+0x1da4>
    3b18:	4581                	li	a1,0
    3b1a:	8526                	mv	a0,s1
...
0000000000003b56 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b7e:	a5e50513          	addi	a0,a0,-1442 # 65d8 <malloc+0xe1c>
    3b82:	00002097          	auipc	ra,0x2
    3b86:	b7c080e7          	jalr	-1156(ra) # 56fe <printf>
    exit(1);
    3b8a:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3bac:	87050513          	addi	a0,a0,-1936 # 6418 <malloc+0xc5c>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	b4e080e7          	jalr	-1202(ra) # 56fe <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3bf0:	06458593          	addi	a1,a1,100 # 5c50 <malloc+0x494>
    ...
    3c1a:	80250513          	addi	a0,a0,-2046 # 6418 <malloc+0xc5c>
    3c1e:	00002097          	auipc	ra,0x2
    3c22:	ae0080e7          	jalr	-1312(ra) # 56fe <printf>
     exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c34:	94050513          	addi	a0,a0,-1728 # 7570 <malloc+0x1db4>
    3c38:	00002097          	auipc	ra,0x2
    3c3c:	ac6080e7          	jalr	-1338(ra) # 56fe <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c54:	af858593          	addi	a1,a1,-1288 # b748 <buf>
    ...
    3c6e:	91e50513          	addi	a0,a0,-1762 # 7588 <malloc+0x1dcc>
    3c72:	00002097          	auipc	ra,0x2
    3c76:	a8c080e7          	jalr	-1396(ra) # 56fe <printf>
}
  ...
  printf("kill... ");
    ...
    3c9a:	90a50513          	addi	a0,a0,-1782 # 75a0 <malloc+0x1de4>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	a60080e7          	jalr	-1440(ra) # 56fe <printf>
  kill(pid1);
    3ca6:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3cc8:	8ec50513          	addi	a0,a0,-1812 # 75b0 <malloc+0x1df4>
    3ccc:	00002097          	auipc	ra,0x2
    3cd0:	a32080e7          	jalr	-1486(ra) # 56fe <printf>
  wait(0);
    3cd4:	4501                	li	a0,0
...
0000000000003cf4 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d2a:	7fa50513          	addi	a0,a0,2042 # 6520 <malloc+0xd64>
    3d2e:	00002097          	auipc	ra,0x2
    3d32:	9d0080e7          	jalr	-1584(ra) # 56fe <printf>
    exit(1);
    3d36:	4505                	li	a0,1
    ...
    3d5e:	ef658593          	addi	a1,a1,-266 # 5c50 <malloc+0x494>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e22:	7a250513          	addi	a0,a0,1954 # 75c0 <malloc+0x1e04>
    3e26:	00002097          	auipc	ra,0x2
    3e2a:	8d8080e7          	jalr	-1832(ra) # 56fe <printf>
    exit(1);
    3e2e:	4505                	li	a0,1
    ...
    3e3e:	5de50513          	addi	a0,a0,1502 # 6418 <malloc+0xc5c>
    3e42:	00002097          	auipc	ra,0x2
    3e46:	8bc080e7          	jalr	-1860(ra) # 56fe <printf>
    exit(1);
    3e4a:	4505                	li	a0,1
    ...
    3e74:	6705                	lui	a4,0x1
      n += *(a+i);
    3e76:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f18a8>
    ...
    3e88:	75c50513          	addi	a0,a0,1884 # 75e0 <malloc+0x1e24>
    3e8c:	00002097          	auipc	ra,0x2
    3e90:	872080e7          	jalr	-1934(ra) # 56fe <printf>
    exit(1);
    3e94:	4505                	li	a0,1
...
0000000000003ea8 <reparent>:
{
  ...
  exit(0);
    ...
    3efc:	52050513          	addi	a0,a0,1312 # 6418 <malloc+0xc5c>
    3f00:	00001097          	auipc	ra,0x1
    3f04:	7fe080e7          	jalr	2046(ra) # 56fe <printf>
      exit(1);
    3f08:	4505                	li	a0,1
    ...
    3f18:	68c50513          	addi	a0,a0,1676 # 65a0 <malloc+0xde4>
    3f1c:	00001097          	auipc	ra,0x1
    3f20:	7e2080e7          	jalr	2018(ra) # 56fe <printf>
        exit(1);
    3f24:	4505                	li	a0,1
...
0000000000003f58 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3fa2:	81e080e7          	jalr	-2018(ra) # 57bc <malloc>
    ...
    3fdc:	63850513          	addi	a0,a0,1592 # 7610 <malloc+0x1e54>
    3fe0:	00001097          	auipc	ra,0x1
    3fe4:	71e080e7          	jalr	1822(ra) # 56fe <printf>
      exit(1);
    3fe8:	4505                	li	a0,1
...
0000000000003ffc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4092:	5a250513          	addi	a0,a0,1442 # 7630 <malloc+0x1e74>
    4096:	00001097          	auipc	ra,0x1
    409a:	668080e7          	jalr	1640(ra) # 56fe <printf>
    exit(1);
    409e:	4505                	li	a0,1
    ...
    40ae:	5ae50513          	addi	a0,a0,1454 # 7658 <malloc+0x1e9c>
    40b2:	00001097          	auipc	ra,0x1
    40b6:	64c080e7          	jalr	1612(ra) # 56fe <printf>
      exit(1);
    40ba:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    40f2:	93a50513          	addi	a0,a0,-1734 # 5a28 <malloc+0x26c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4132:	54a50513          	addi	a0,a0,1354 # 7678 <malloc+0x1ebc>
    4136:	00001097          	auipc	ra,0x1
    413a:	5c8080e7          	jalr	1480(ra) # 56fe <printf>
    exit(1);
    413e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    416e:	8be50513          	addi	a0,a0,-1858 # 5a28 <malloc+0x26c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4194:	51050513          	addi	a0,a0,1296 # 76a0 <malloc+0x1ee4>
    4198:	00001097          	auipc	ra,0x1
    419c:	566080e7          	jalr	1382(ra) # 56fe <printf>
    exit(1);
    41a0:	4505                	li	a0,1
...
00000000000041b4 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41da:	6d278793          	addi	a5,a5,1746 # 58a8 <malloc+0xec>
    41de:	f6f43823          	sd	a5,-144(s0)
    41e2:	00001797          	auipc	a5,0x1
    41e6:	6ce78793          	addi	a5,a5,1742 # 58b0 <malloc+0xf4>
    41ea:	f6f43c23          	sd	a5,-136(s0)
    41ee:	00001797          	auipc	a5,0x1
    41f2:	6ca78793          	addi	a5,a5,1738 # 58b8 <malloc+0xfc>
    41f6:	f8f43023          	sd	a5,-128(s0)
    41fa:	00001797          	auipc	a5,0x1
    41fe:	6c678793          	addi	a5,a5,1734 # 58c0 <malloc+0x104>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4256:	4f6a0a13          	addi	s4,s4,1270 # b748 <buf>
    425a:	00007a97          	auipc	s5,0x7
    425e:	4efa8a93          	addi	s5,s5,1263 # b749 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4276:	59650513          	addi	a0,a0,1430 # 6808 <malloc+0x104c>
    427a:	00001097          	auipc	ra,0x1
    427e:	484080e7          	jalr	1156(ra) # 56fe <printf>
      exit(1);
    4282:	4505                	li	a0,1
    ...
    42f2:	3ca50513          	addi	a0,a0,970 # 76b8 <malloc+0x1efc>
    42f6:	00001097          	auipc	ra,0x1
    42fa:	408080e7          	jalr	1032(ra) # 56fe <printf>
        exit(1);
    42fe:	4505                	li	a0,1
    ...
    430c:	3c050513          	addi	a0,a0,960 # 76c8 <malloc+0x1f0c>
    4310:	00001097          	auipc	ra,0x1
    4314:	3ee080e7          	jalr	1006(ra) # 56fe <printf>
          exit(1);
    4318:	4505                	li	a0,1
    ...
    4334:	3b050513          	addi	a0,a0,944 # 76e0 <malloc+0x1f24>
    4338:	00001097          	auipc	ra,0x1
    433c:	3c6080e7          	jalr	966(ra) # 56fe <printf>
          exit(1);
    4340:	4505                	li	a0,1
    ...
    4364:	3e878793          	addi	a5,a5,1000 # b748 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43c2:	33250513          	addi	a0,a0,818 # 76f0 <malloc+0x1f34>
    43c6:	00001097          	auipc	ra,0x1
    43ca:	338080e7          	jalr	824(ra) # 56fe <printf>
      exit(1);
    43ce:	4505                	li	a0,1
...
00000000000043f6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4424:	2e8b8b93          	addi	s7,s7,744 # 7708 <malloc+0x1f4c>
  for(i = 0; i < N; i++){
    ...
    4466:	2ae50513          	addi	a0,a0,686 # 7710 <malloc+0x1f54>
    446a:	00001097          	auipc	ra,0x1
    446e:	294080e7          	jalr	660(ra) # 56fe <printf>
        exit(1);
    4472:	4505                	li	a0,1
    ...
    4484:	28850513          	addi	a0,a0,648 # 7708 <malloc+0x1f4c>
  ...
  fd = open(".", 0);
    ...
    44bc:	dc050513          	addi	a0,a0,-576 # 6278 <malloc+0xabc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4532:	20250513          	addi	a0,a0,514 # 7730 <malloc+0x1f74>
    4536:	00001097          	auipc	ra,0x1
    453a:	1c8080e7          	jalr	456(ra) # 56fe <printf>
        exit(1);
    453e:	4505                	li	a0,1
    ...
    4552:	20250513          	addi	a0,a0,514 # 7750 <malloc+0x1f94>
    4556:	00001097          	auipc	ra,0x1
    455a:	1a8080e7          	jalr	424(ra) # 56fe <printf>
        exit(1);
    455e:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    458a:	1f250513          	addi	a0,a0,498 # 7778 <malloc+0x1fbc>
    458e:	00001097          	auipc	ra,0x1
    4592:	170080e7          	jalr	368(ra) # 56fe <printf>
    exit(1);
    4596:	4505                	li	a0,1
    ...
    45a6:	e7650513          	addi	a0,a0,-394 # 6418 <malloc+0xc5c>
    45aa:	00001097          	auipc	ra,0x1
    45ae:	154080e7          	jalr	340(ra) # 56fe <printf>
      exit(1);
    45b2:	4505                	li	a0,1
...
0000000000004750 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d8:	fdc50513          	addi	a0,a0,-36 # 77b0 <malloc+0x1ff4>
  ...
  for(i = 0; ; i++){
    ...
    483c:	f8850513          	addi	a0,a0,-120 # 77c0 <malloc+0x2004>
    4840:	00001097          	auipc	ra,0x1
    4844:	ebe080e7          	jalr	-322(ra) # 56fe <printf>
    exit(1);
    4848:	4505                	li	a0,1
    ...
    4858:	f8c50513          	addi	a0,a0,-116 # 77e0 <malloc+0x2024>
    485c:	00001097          	auipc	ra,0x1
    4860:	ea2080e7          	jalr	-350(ra) # 56fe <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    4874:	f9050513          	addi	a0,a0,-112 # 7800 <malloc+0x2044>
    4878:	00001097          	auipc	ra,0x1
    487c:	e86080e7          	jalr	-378(ra) # 56fe <printf>
    exit(1);
    4880:	4505                	li	a0,1
    ...
    4890:	f9450513          	addi	a0,a0,-108 # 7820 <malloc+0x2064>
    4894:	00001097          	auipc	ra,0x1
    4898:	e6a080e7          	jalr	-406(ra) # 56fe <printf>
      exit(1);
    489c:	4505                	li	a0,1
    ...
    48ac:	f9850513          	addi	a0,a0,-104 # 7840 <malloc+0x2084>
    48b0:	00001097          	auipc	ra,0x1
    48b4:	e4e080e7          	jalr	-434(ra) # 56fe <printf>
      exit(1);
    48b8:	4505                	li	a0,1
    ...
    48c8:	f9450513          	addi	a0,a0,-108 # 7858 <malloc+0x209c>
    48cc:	00001097          	auipc	ra,0x1
    48d0:	e32080e7          	jalr	-462(ra) # 56fe <printf>
      exit(1);
    48d4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    48f6:	ebe50513          	addi	a0,a0,-322 # 77b0 <malloc+0x1ff4>
    ...
    491a:	f6250513          	addi	a0,a0,-158 # 7878 <malloc+0x20bc>
    491e:	00001097          	auipc	ra,0x1
    4922:	de0080e7          	jalr	-544(ra) # 56fe <printf>
    exit(1);
    4926:	4505                	li	a0,1
...
0000000000004930 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    4940:	f5c50513          	addi	a0,a0,-164 # 7898 <malloc+0x20dc>
    4944:	00001097          	auipc	ra,0x1
    4948:	dba080e7          	jalr	-582(ra) # 56fe <printf>
  if(mkdir("dir0") < 0){
    494c:	00003517          	auipc	a0,0x3
    4950:	f5c50513          	addi	a0,a0,-164 # 78a8 <malloc+0x20ec>
  ...
  if(chdir("dir0") < 0){
    ...
    4964:	f4850513          	addi	a0,a0,-184 # 78a8 <malloc+0x20ec>
  ...
  if(chdir("..") < 0){
    ...
    4978:	98c50513          	addi	a0,a0,-1652 # 7300 <malloc+0x1b44>
  ...
  if(unlink("dir0") < 0){
    ...
    498c:	f2050513          	addi	a0,a0,-224 # 78a8 <malloc+0x20ec>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49a0:	f5c50513          	addi	a0,a0,-164 # 78f8 <malloc+0x213c>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	d5a080e7          	jalr	-678(ra) # 56fe <printf>
}
    ...
    49bc:	2e850513          	addi	a0,a0,744 # 6ca0 <malloc+0x14e4>
    49c0:	00001097          	auipc	ra,0x1
    49c4:	d3e080e7          	jalr	-706(ra) # 56fe <printf>
    exit(1);
    49c8:	4505                	li	a0,1
    ...
    49d8:	edc50513          	addi	a0,a0,-292 # 78b0 <malloc+0x20f4>
    49dc:	00001097          	auipc	ra,0x1
    49e0:	d22080e7          	jalr	-734(ra) # 56fe <printf>
    exit(1);
    49e4:	4505                	li	a0,1
    ...
    49f4:	ed850513          	addi	a0,a0,-296 # 78c8 <malloc+0x210c>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	d06080e7          	jalr	-762(ra) # 56fe <printf>
    exit(1);
    4a00:	4505                	li	a0,1
    ...
    4a10:	ed450513          	addi	a0,a0,-300 # 78e0 <malloc+0x2124>
    4a14:	00001097          	auipc	ra,0x1
    4a18:	cea080e7          	jalr	-790(ra) # 56fe <printf>
    exit(1);
    4a1c:	4505                	li	a0,1
...
0000000000004a26 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a48:	ecc50513          	addi	a0,a0,-308 # 7910 <malloc+0x2154>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	cb2080e7          	jalr	-846(ra) # 56fe <printf>
  for(nfiles = 0; ; nfiles++){
    4a54:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4a68:	ebcc8c93          	addi	s9,s9,-324 # 7920 <malloc+0x2164>
    int total = 0;
    4a6c:	4d81                	li	s11,0
    ...
    4ac0:	c42080e7          	jalr	-958(ra) # 56fe <printf>
    ...
    4ae2:	e5250513          	addi	a0,a0,-430 # 7930 <malloc+0x2174>
    4ae6:	00001097          	auipc	ra,0x1
    4aea:	c18080e7          	jalr	-1000(ra) # 56fe <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4b58:	e0c50513          	addi	a0,a0,-500 # 7960 <malloc+0x21a4>
    4b5c:	00001097          	auipc	ra,0x1
    4b60:	ba2080e7          	jalr	-1118(ra) # 56fe <printf>
}
    ...
    4ba8:	da450513          	addi	a0,a0,-604 # 7948 <malloc+0x218c>
    4bac:	00001097          	auipc	ra,0x1
    4bb0:	b52080e7          	jalr	-1198(ra) # 56fe <printf>
    close(fd);
    4bb4:	854a                	mv	a0,s2
...
0000000000004bf6 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c6a:	d1250513          	addi	a0,a0,-750 # 7978 <malloc+0x21bc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c82:	fd258593          	addi	a1,a1,-46 # 5c50 <malloc+0x494>
    ...
    4c98:	d0450513          	addi	a0,a0,-764 # 7998 <malloc+0x21dc>
    4c9c:	00001097          	auipc	ra,0x1
    4ca0:	a62080e7          	jalr	-1438(ra) # 56fe <printf>
    exit(1);
    4ca4:	4505                	li	a0,1
    ...
    4cb2:	cd250513          	addi	a0,a0,-814 # 7980 <malloc+0x21c4>
    4cb6:	00001097          	auipc	ra,0x1
    4cba:	a48080e7          	jalr	-1464(ra) # 56fe <printf>
      exit(1);
    4cbe:	4505                	li	a0,1
    ...
    4ccc:	cb850513          	addi	a0,a0,-840 # 7980 <malloc+0x21c4>
    4cd0:	00001097          	auipc	ra,0x1
    4cd4:	a2e080e7          	jalr	-1490(ra) # 56fe <printf>
    exit(1);
    4cd8:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4cf0:	c8c50513          	addi	a0,a0,-884 # 7978 <malloc+0x21bc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d46:	f0e98993          	addi	s3,s3,-242 # 5c50 <malloc+0x494>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d78:	c7450513          	addi	a0,a0,-908 # 79e8 <malloc+0x222c>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	982080e7          	jalr	-1662(ra) # 56fe <printf>
        exit(1);
    4d84:	4505                	li	a0,1
    ...
    4d92:	c1a50513          	addi	a0,a0,-998 # 79a8 <malloc+0x21ec>
    4d96:	00001097          	auipc	ra,0x1
    4d9a:	968080e7          	jalr	-1688(ra) # 56fe <printf>
    exit(1);
    4d9e:	4505                	li	a0,1
    ...
    4dac:	c2050513          	addi	a0,a0,-992 # 79c8 <malloc+0x220c>
    4db0:	00001097          	auipc	ra,0x1
    4db4:	94e080e7          	jalr	-1714(ra) # 56fe <printf>
    exit(1);
    4db8:	4505                	li	a0,1
  ...
  while(1){
    ...
    4dfa:	c1250513          	addi	a0,a0,-1006 # 7a08 <malloc+0x224c>
    4dfe:	00001097          	auipc	ra,0x1
    4e02:	900080e7          	jalr	-1792(ra) # 56fe <printf>
      exit(1);
    4e06:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e4a:	be250513          	addi	a0,a0,-1054 # 7a28 <malloc+0x226c>
    4e4e:	00001097          	auipc	ra,0x1
    4e52:	8b0080e7          	jalr	-1872(ra) # 56fe <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4e7a:	bda50513          	addi	a0,a0,-1062 # 7a50 <malloc+0x2294>
    4e7e:	00001097          	auipc	ra,0x1
    4e82:	880080e7          	jalr	-1920(ra) # 56fe <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4e9e:	b9e50513          	addi	a0,a0,-1122 # 7a38 <malloc+0x227c>
    4ea2:	00001097          	auipc	ra,0x1
    4ea6:	85c080e7          	jalr	-1956(ra) # 56fe <printf>
    exit(1);
    4eaa:	4505                	li	a0,1
    ...
    4ec6:	b9650513          	addi	a0,a0,-1130 # 7a58 <malloc+0x229c>
    4eca:	00001097          	auipc	ra,0x1
    4ece:	834080e7          	jalr	-1996(ra) # 56fe <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f0e:	c6678793          	addi	a5,a5,-922 # 7b70 <malloc+0x23b4>
    4f12:	c4040713          	addi	a4,s0,-960
    4f16:	00003817          	auipc	a6,0x3
    4f1a:	fda80813          	addi	a6,a6,-38 # 7ef0 <malloc+0x2734>
  ...
  printf("usertests starting\n");
    ...
    4f3e:	bd650513          	addi	a0,a0,-1066 # 7b10 <malloc+0x2354>
    4f42:	00000097          	auipc	ra,0x0
    4f46:	7bc080e7          	jalr	1980(ra) # 56fe <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    4f76:	b5650513          	addi	a0,a0,-1194 # 7ac8 <malloc+0x230c>
    4f7a:	00000097          	auipc	ra,0x0
    4f7e:	784080e7          	jalr	1924(ra) # 56fe <printf>
    exit(1);
    4f82:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f92:	ad258593          	addi	a1,a1,-1326 # 7a60 <malloc+0x22a4>
    ...
    4fa8:	ba458593          	addi	a1,a1,-1116 # 7b48 <malloc+0x238c>
    ...
    4fcc:	aa050513          	addi	a0,a0,-1376 # 7a68 <malloc+0x22ac>
    4fd0:	00000097          	auipc	ra,0x0
    4fd4:	72e080e7          	jalr	1838(ra) # 56fe <printf>
    exit(1);
    4fd8:	4505                	li	a0,1
    ...
    4ff6:	70c080e7          	jalr	1804(ra) # 56fe <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5038:	a7c50513          	addi	a0,a0,-1412 # 7ab0 <malloc+0x22f4>
    503c:	00000097          	auipc	ra,0x0
    5040:	6c2080e7          	jalr	1730(ra) # 56fe <printf>
    exit(1);
    5044:	4505                	li	a0,1
    ...
    5052:	aaa50513          	addi	a0,a0,-1366 # 7af8 <malloc+0x233c>
    5056:	00000097          	auipc	ra,0x0
    505a:	6a8080e7          	jalr	1704(ra) # 56fe <printf>
    exit(0);
    505e:	4501                	li	a0,0
    ...
    506e:	694080e7          	jalr	1684(ra) # 56fe <printf>
        if(continuous != 2)
    ...
    50b0:	ac478793          	addi	a5,a5,-1340 # 7b70 <malloc+0x23b4>
    50b4:	c4040713          	addi	a4,s0,-960
    50b8:	00003817          	auipc	a6,0x3
    50bc:	e3880813          	addi	a6,a6,-456 # 7ef0 <malloc+0x2734>
    ...
    50e0:	a4c50513          	addi	a0,a0,-1460 # 7b28 <malloc+0x236c>
    50e4:	00000097          	auipc	ra,0x0
    50e8:	61a080e7          	jalr	1562(ra) # 56fe <printf>
        printf("SOME TESTS FAILED\n");
    50ec:	00003a97          	auipc	s5,0x3
    50f0:	9c4a8a93          	addi	s5,s5,-1596 # 7ab0 <malloc+0x22f4>
        if(continuous != 2)
    50f4:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f6:	00003b17          	auipc	s6,0x3
    50fa:	99ab0b13          	addi	s6,s6,-1638 # 7a90 <malloc+0x22d4>
...
putc(int fd, char c)
{
    ...
    542e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5432:	4605                	li	a2,1
    5434:	fef40593          	addi	a1,s0,-17
    5438:	00000097          	auipc	ra,0x0
    543c:	f56080e7          	jalr	-170(ra) # 538e <write>
}
    5440:	60e2                	ld	ra,24(sp)
    5442:	6442                	ld	s0,16(sp)
    5444:	6105                	addi	sp,sp,32
    5446:	8082                	ret

0000000000005448 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5448:	7139                	addi	sp,sp,-64
    544a:	fc06                	sd	ra,56(sp)
    544c:	f822                	sd	s0,48(sp)
    544e:	f426                	sd	s1,40(sp)
    5450:	f04a                	sd	s2,32(sp)
    5452:	ec4e                	sd	s3,24(sp)
    5454:	0080                	addi	s0,sp,64
    5456:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5458:	c299                	beqz	a3,545e <printint+0x16>
    545a:	0805c863          	bltz	a1,54ea <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    545e:	2581                	sext.w	a1,a1
  neg = 0;
    5460:	4881                	li	a7,0
    5462:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5468:	2601                	sext.w	a2,a2
    546a:	00003517          	auipc	a0,0x3
    546e:	a8e50513          	addi	a0,a0,-1394 # 7ef8 <digits>
    5472:	883a                	mv	a6,a4
    5474:	2705                	addiw	a4,a4,1
    5476:	02c5f7bb          	remuw	a5,a1,a2
    547a:	1782                	slli	a5,a5,0x20
    547c:	9381                	srli	a5,a5,0x20
    547e:	97aa                	add	a5,a5,a0
    5480:	0007c783          	lbu	a5,0(a5)
    5484:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5488:	0005879b          	sext.w	a5,a1
    548c:	02c5d5bb          	divuw	a1,a1,a2
    5490:	0685                	addi	a3,a3,1
    5492:	fec7f0e3          	bgeu	a5,a2,5472 <printint+0x2a>
  if(neg)
    5496:	00088b63          	beqz	a7,54ac <printint+0x64>
    buf[i++] = '-';
    549a:	fd040793          	addi	a5,s0,-48
    549e:	973e                	add	a4,a4,a5
    54a0:	02d00793          	li	a5,45
    54a4:	fef70823          	sb	a5,-16(a4)
    54a8:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    54ac:	02e05863          	blez	a4,54dc <printint+0x94>
    54b0:	fc040793          	addi	a5,s0,-64
    54b4:	00e78933          	add	s2,a5,a4
    54b8:	fff78993          	addi	s3,a5,-1
    54bc:	99ba                	add	s3,s3,a4
    54be:	377d                	addiw	a4,a4,-1
    54c0:	1702                	slli	a4,a4,0x20
    54c2:	9301                	srli	a4,a4,0x20
    54c4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    54c8:	fff94583          	lbu	a1,-1(s2)
    54cc:	8526                	mv	a0,s1
    54ce:	00000097          	auipc	ra,0x0
    54d2:	f58080e7          	jalr	-168(ra) # 5426 <putc>
  while(--i >= 0)
    54d6:	197d                	addi	s2,s2,-1
    54d8:	ff3918e3          	bne	s2,s3,54c8 <printint+0x80>
}
    54dc:	70e2                	ld	ra,56(sp)
    54de:	7442                	ld	s0,48(sp)
    ...
    54e8:	8082                	ret
    x = -xx;
    54ea:	40b005bb          	negw	a1,a1
    neg = 1;
    54ee:	4885                	li	a7,1
    x = -xx;
    54f0:	bf8d                	j	5462 <printint+0x1a>

00000000000054f2 <vprintf>:
}
...
{
    54f2:	7119                	addi	sp,sp,-128
    54f4:	fc86                	sd	ra,120(sp)
    54f6:	f8a2                	sd	s0,112(sp)
    54f8:	f4a6                	sd	s1,104(sp)
    54fa:	f0ca                	sd	s2,96(sp)
    54fc:	ecce                	sd	s3,88(sp)
    54fe:	e8d2                	sd	s4,80(sp)
    5500:	e4d6                	sd	s5,72(sp)
    5502:	e0da                	sd	s6,64(sp)
    5504:	fc5e                	sd	s7,56(sp)
    5506:	f862                	sd	s8,48(sp)
    5508:	f466                	sd	s9,40(sp)
    550a:	f06a                	sd	s10,32(sp)
    550c:	ec6e                	sd	s11,24(sp)
    550e:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5510:	0005c903          	lbu	s2,0(a1)
    5514:	18090f63          	beqz	s2,56b2 <vprintf+0x1c0>
    5518:	8aaa                	mv	s5,a0
    551a:	8b32                	mv	s6,a2
    551c:	00158493          	addi	s1,a1,1
  state = 0;
    5520:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5522:	02500a13          	li	s4,37
      if(c == 'd'){
    5526:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    552a:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    552e:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5532:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5536:	00003b97          	auipc	s7,0x3
    553a:	9c2b8b93          	addi	s7,s7,-1598 # 7ef8 <digits>
    553e:	a839                	j	555c <vprintf+0x6a>
        putc(fd, c);
    5540:	85ca                	mv	a1,s2
    5542:	8556                	mv	a0,s5
    5544:	00000097          	auipc	ra,0x0
    5548:	ee2080e7          	jalr	-286(ra) # 5426 <putc>
    554c:	a019                	j	5552 <vprintf+0x60>
    } else if(state == '%'){
    554e:	01498f63          	beq	s3,s4,556c <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5552:	0485                	addi	s1,s1,1
    5554:	fff4c903          	lbu	s2,-1(s1)
    5558:	14090d63          	beqz	s2,56b2 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    555c:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5560:	fe0997e3          	bnez	s3,554e <vprintf+0x5c>
      if(c == '%'){
    5564:	fd479ee3          	bne	a5,s4,5540 <vprintf+0x4e>
        state = '%';
    5568:	89be                	mv	s3,a5
    556a:	b7e5                	j	5552 <vprintf+0x60>
      if(c == 'd'){
    556c:	05878063          	beq	a5,s8,55ac <vprintf+0xba>
      } else if(c == 'l') {
    5570:	05978c63          	beq	a5,s9,55c8 <vprintf+0xd6>
      } else if(c == 'x') {
    5574:	07a78863          	beq	a5,s10,55e4 <vprintf+0xf2>
      } else if(c == 'p') {
    5578:	09b78463          	beq	a5,s11,5600 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    557c:	07300713          	li	a4,115
    5580:	0ce78663          	beq	a5,a4,564c <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5584:	06300713          	li	a4,99
    5588:	0ee78e63          	beq	a5,a4,5684 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    558c:	11478863          	beq	a5,s4,569c <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5598:	e92080e7          	jalr	-366(ra) # 5426 <putc>
        putc(fd, c);
    559c:	85ca                	mv	a1,s2
    559e:	8556                	mv	a0,s5
    55a0:	00000097          	auipc	ra,0x0
    55a4:	e86080e7          	jalr	-378(ra) # 5426 <putc>
      }
      state = 0;
    55a8:	4981                	li	s3,0
    55aa:	b765                	j	5552 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    55ac:	008b0913          	addi	s2,s6,8
    55b0:	4685                	li	a3,1
    55b2:	4629                	li	a2,10
    55b4:	000b2583          	lw	a1,0(s6)
    55b8:	8556                	mv	a0,s5
    55ba:	00000097          	auipc	ra,0x0
    55be:	e8e080e7          	jalr	-370(ra) # 5448 <printint>
    55c2:	8b4a                	mv	s6,s2
      state = 0;
    55c4:	4981                	li	s3,0
    55c6:	b771                	j	5552 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    55c8:	008b0913          	addi	s2,s6,8
    55cc:	4681                	li	a3,0
    55ce:	4629                	li	a2,10
    55d0:	000b2583          	lw	a1,0(s6)
    55d4:	8556                	mv	a0,s5
    55d6:	00000097          	auipc	ra,0x0
    55da:	e72080e7          	jalr	-398(ra) # 5448 <printint>
    55de:	8b4a                	mv	s6,s2
      state = 0;
    55e0:	4981                	li	s3,0
    55e2:	bf85                	j	5552 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    55e4:	008b0913          	addi	s2,s6,8
    55e8:	4681                	li	a3,0
    55ea:	4641                	li	a2,16
    55ec:	000b2583          	lw	a1,0(s6)
    55f0:	8556                	mv	a0,s5
    55f2:	00000097          	auipc	ra,0x0
    55f6:	e56080e7          	jalr	-426(ra) # 5448 <printint>
    55fa:	8b4a                	mv	s6,s2
      state = 0;
    55fc:	4981                	li	s3,0
    55fe:	bf91                	j	5552 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5600:	008b0793          	addi	a5,s6,8
    5604:	f8f43423          	sd	a5,-120(s0)
    5608:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    560c:	03000593          	li	a1,48
    5610:	8556                	mv	a0,s5
    5612:	00000097          	auipc	ra,0x0
    5616:	e14080e7          	jalr	-492(ra) # 5426 <putc>
  putc(fd, 'x');
    561a:	85ea                	mv	a1,s10
    561c:	8556                	mv	a0,s5
    561e:	00000097          	auipc	ra,0x0
    5622:	e08080e7          	jalr	-504(ra) # 5426 <putc>
    5626:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5628:	03c9d793          	srli	a5,s3,0x3c
    562c:	97de                	add	a5,a5,s7
    562e:	0007c583          	lbu	a1,0(a5)
    5632:	8556                	mv	a0,s5
    5634:	00000097          	auipc	ra,0x0
    5638:	df2080e7          	jalr	-526(ra) # 5426 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    563c:	0992                	slli	s3,s3,0x4
    563e:	397d                	addiw	s2,s2,-1
    5640:	fe0914e3          	bnez	s2,5628 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5644:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5648:	4981                	li	s3,0
    564a:	b721                	j	5552 <vprintf+0x60>
        s = va_arg(ap, char*);
    564c:	008b0993          	addi	s3,s6,8
    5650:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5654:	02090163          	beqz	s2,5676 <vprintf+0x184>
        while(*s != 0){
    5658:	00094583          	lbu	a1,0(s2)
    565c:	c9a1                	beqz	a1,56ac <vprintf+0x1ba>
          putc(fd, *s);
    565e:	8556                	mv	a0,s5
    5660:	00000097          	auipc	ra,0x0
    5664:	dc6080e7          	jalr	-570(ra) # 5426 <putc>
          s++;
    5668:	0905                	addi	s2,s2,1
        while(*s != 0){
    566a:	00094583          	lbu	a1,0(s2)
    566e:	f9e5                	bnez	a1,565e <vprintf+0x16c>
        s = va_arg(ap, char*);
    5670:	8b4e                	mv	s6,s3
      state = 0;
    5672:	4981                	li	s3,0
    5674:	bdf9                	j	5552 <vprintf+0x60>
          s = "(null)";
    5676:	00003917          	auipc	s2,0x3
    567a:	87a90913          	addi	s2,s2,-1926 # 7ef0 <malloc+0x2734>
        while(*s != 0){
    567e:	02800593          	li	a1,40
    5682:	bff1                	j	565e <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5684:	008b0913          	addi	s2,s6,8
    5688:	000b4583          	lbu	a1,0(s6)
    568c:	8556                	mv	a0,s5
    568e:	00000097          	auipc	ra,0x0
    5692:	d98080e7          	jalr	-616(ra) # 5426 <putc>
    5696:	8b4a                	mv	s6,s2
      state = 0;
    5698:	4981                	li	s3,0
    569a:	bd65                	j	5552 <vprintf+0x60>
        putc(fd, c);
    569c:	85d2                	mv	a1,s4
    569e:	8556                	mv	a0,s5
    56a0:	00000097          	auipc	ra,0x0
    56a4:	d86080e7          	jalr	-634(ra) # 5426 <putc>
      state = 0;
    56a8:	4981                	li	s3,0
    56aa:	b565                	j	5552 <vprintf+0x60>
        s = va_arg(ap, char*);
    56ac:	8b4e                	mv	s6,s3
      state = 0;
    56ae:	4981                	li	s3,0
    56b0:	b54d                	j	5552 <vprintf+0x60>
    }
  }
}
    56b2:	70e6                	ld	ra,120(sp)
    56b4:	7446                	ld	s0,112(sp)
    56b6:	74a6                	ld	s1,104(sp)
    56b8:	7906                	ld	s2,96(sp)
    56ba:	69e6                	ld	s3,88(sp)
    56bc:	6a46                	ld	s4,80(sp)
    56be:	6aa6                	ld	s5,72(sp)
    56c0:	6b06                	ld	s6,64(sp)
    56c2:	7be2                	ld	s7,56(sp)
    56c4:	7c42                	ld	s8,48(sp)
    56c6:	7ca2                	ld	s9,40(sp)
    56c8:	7d02                	ld	s10,32(sp)
    56ca:	6de2                	ld	s11,24(sp)
    56cc:	6109                	addi	sp,sp,128
    56ce:	8082                	ret

00000000000056d0 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    56d0:	715d                	addi	sp,sp,-80
    56d2:	ec06                	sd	ra,24(sp)
    56d4:	e822                	sd	s0,16(sp)
    56d6:	1000                	addi	s0,sp,32
    56d8:	e010                	sd	a2,0(s0)
    56da:	e414                	sd	a3,8(s0)
    56dc:	e818                	sd	a4,16(s0)
    56de:	ec1c                	sd	a5,24(s0)
    56e0:	03043023          	sd	a6,32(s0)
    56e4:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    56e8:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    56ec:	8622                	mv	a2,s0
    56ee:	00000097          	auipc	ra,0x0
    56f2:	e04080e7          	jalr	-508(ra) # 54f2 <vprintf>
}
    56f6:	60e2                	ld	ra,24(sp)
    56f8:	6442                	ld	s0,16(sp)
    56fa:	6161                	addi	sp,sp,80
    56fc:	8082                	ret

00000000000056fe <printf>:

void
printf(const char *fmt, ...)
{
    56fe:	711d                	addi	sp,sp,-96
    5700:	ec06                	sd	ra,24(sp)
    5702:	e822                	sd	s0,16(sp)
    5704:	1000                	addi	s0,sp,32
    5706:	e40c                	sd	a1,8(s0)
    5708:	e810                	sd	a2,16(s0)
    570a:	ec14                	sd	a3,24(s0)
    570c:	f018                	sd	a4,32(s0)
    570e:	f41c                	sd	a5,40(s0)
    5710:	03043823          	sd	a6,48(s0)
    5714:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5718:	00840613          	addi	a2,s0,8
    571c:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5720:	85aa                	mv	a1,a0
    5722:	4505                	li	a0,1
    5724:	00000097          	auipc	ra,0x0
    5728:	dce080e7          	jalr	-562(ra) # 54f2 <vprintf>
}
    572c:	60e2                	ld	ra,24(sp)
    572e:	6442                	ld	s0,16(sp)
    5730:	6125                	addi	sp,sp,96
    5732:	8082                	ret

0000000000005734 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    573a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    573e:	00002797          	auipc	a5,0x2
    5742:	7ea7b783          	ld	a5,2026(a5) # 7f28 <freep>
    5746:	a805                	j	5776 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5748:	4618                	lw	a4,8(a2)
    574a:	9db9                	addw	a1,a1,a4
    574c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5750:	6398                	ld	a4,0(a5)
    5752:	6318                	ld	a4,0(a4)
    5754:	fee53823          	sd	a4,-16(a0)
    5758:	a091                	j	579c <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    575a:	ff852703          	lw	a4,-8(a0)
    575e:	9e39                	addw	a2,a2,a4
    5760:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5762:	ff053703          	ld	a4,-16(a0)
    5766:	e398                	sd	a4,0(a5)
    5768:	a099                	j	57ae <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    576a:	6398                	ld	a4,0(a5)
    576c:	00e7e463          	bltu	a5,a4,5774 <free+0x40>
    5770:	00e6ea63          	bltu	a3,a4,5784 <free+0x50>
{
    5774:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5776:	fed7fae3          	bgeu	a5,a3,576a <free+0x36>
    577a:	6398                	ld	a4,0(a5)
    577c:	00e6e463          	bltu	a3,a4,5784 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5780:	fee7eae3          	bltu	a5,a4,5774 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5784:	ff852583          	lw	a1,-8(a0)
    5788:	6390                	ld	a2,0(a5)
    578a:	02059813          	slli	a6,a1,0x20
    578e:	01c85713          	srli	a4,a6,0x1c
    5792:	9736                	add	a4,a4,a3
    5794:	fae60ae3          	beq	a2,a4,5748 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5798:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    579c:	4790                	lw	a2,8(a5)
    579e:	02061593          	slli	a1,a2,0x20
    57a2:	01c5d713          	srli	a4,a1,0x1c
    57a6:	973e                	add	a4,a4,a5
    57a8:	fae689e3          	beq	a3,a4,575a <free+0x26>
  } else
    p->s.ptr = bp;
    57ac:	e394                	sd	a3,0(a5)
  freep = p;
    57ae:	00002717          	auipc	a4,0x2
    57b2:	76f73d23          	sd	a5,1914(a4) # 7f28 <freep>
}
    57b6:	6422                	ld	s0,8(sp)
    57b8:	0141                	addi	sp,sp,16
    57ba:	8082                	ret

00000000000057bc <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    57bc:	7139                	addi	sp,sp,-64
    57be:	fc06                	sd	ra,56(sp)
    57c0:	f822                	sd	s0,48(sp)
    57c2:	f426                	sd	s1,40(sp)
    57c4:	f04a                	sd	s2,32(sp)
    57c6:	ec4e                	sd	s3,24(sp)
    57c8:	e852                	sd	s4,16(sp)
    57ca:	e456                	sd	s5,8(sp)
    57cc:	e05a                	sd	s6,0(sp)
    57ce:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    57d0:	02051493          	slli	s1,a0,0x20
    57d4:	9081                	srli	s1,s1,0x20
    57d6:	04bd                	addi	s1,s1,15
    57d8:	8091                	srli	s1,s1,0x4
    57da:	0014899b          	addiw	s3,s1,1
    57de:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    57e0:	00002517          	auipc	a0,0x2
    57e4:	74853503          	ld	a0,1864(a0) # 7f28 <freep>
    57e8:	c515                	beqz	a0,5814 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    57ea:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    57ec:	4798                	lw	a4,8(a5)
    57ee:	02977f63          	bgeu	a4,s1,582c <malloc+0x70>
    57f2:	8a4e                	mv	s4,s3
    57f4:	0009871b          	sext.w	a4,s3
    57f8:	6685                	lui	a3,0x1
    57fa:	00d77363          	bgeu	a4,a3,5800 <malloc+0x44>
    57fe:	6a05                	lui	s4,0x1
    5800:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5804:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5808:	00002917          	auipc	s2,0x2
    580c:	72090913          	addi	s2,s2,1824 # 7f28 <freep>
  if(p == (char*)-1)
    5810:	5afd                	li	s5,-1
    5812:	a895                	j	5886 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5814:	00009797          	auipc	a5,0x9
    5818:	f3478793          	addi	a5,a5,-204 # e748 <base>
    581c:	00002717          	auipc	a4,0x2
    5820:	70f73623          	sd	a5,1804(a4) # 7f28 <freep>
    5824:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5826:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    582a:	b7e1                	j	57f2 <malloc+0x36>
      if(p->s.size == nunits)
    582c:	02e48c63          	beq	s1,a4,5864 <malloc+0xa8>
        p->s.size -= nunits;
    5830:	4137073b          	subw	a4,a4,s3
    5834:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5836:	02071693          	slli	a3,a4,0x20
    583a:	01c6d713          	srli	a4,a3,0x1c
    ...
    5868:	bff1                	j	5844 <malloc+0x88>
  hp->s.size = nu;
    586a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    586e:	0541                	addi	a0,a0,16
    5870:	00000097          	auipc	ra,0x0
    5874:	ec4080e7          	jalr	-316(ra) # 5734 <free>
  return freep;
    5878:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    587c:	d971                	beqz	a0,5850 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    587e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5880:	4798                	lw	a4,8(a5)
    5882:	fa9775e3          	bgeu	a4,s1,582c <malloc+0x70>
    if(p == freep)
    5886:	00093703          	ld	a4,0(s2)
    588a:	853e                	mv	a0,a5
    588c:	fef719e3          	bne	a4,a5,587e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5890:	8552                	mv	a0,s4
    5892:	00000097          	auipc	ra,0x0
    5896:	b64080e7          	jalr	-1180(ra) # 53f6 <sbrk>
  if(p == (char*)-1)
    589a:	fd5518e3          	bne	a0,s5,586a <malloc+0xae>
        return 0;
    589e:	4501                	li	a0,0
    58a0:	bf45                	j	5850 <malloc+0x94>
