...
go(int which_child)
{
  ...
  int fd = -1;
     ...
     10c:	2c050513          	addi	a0,a0,704 # 13c8 <malloc+0x124>
    ...
    if(what == 1){
     ...
     292:	35258593          	addi	a1,a1,850 # 15e0 <malloc+0x33c>
     ...
     2b6:	37e50513          	addi	a0,a0,894 # 1630 <malloc+0x38c>
     ...
     2d4:	10850513          	addi	a0,a0,264 # 13d8 <malloc+0x134>
     ...
     35c:	0a050513          	addi	a0,a0,160 # 13f8 <malloc+0x154>
     ...
     37e:	08e50513          	addi	a0,a0,142 # 1408 <malloc+0x164>
     ...
     4b4:	fd850513          	addi	a0,a0,-40 # 1488 <malloc+0x1e4>
     ...
     502:	f8a50513          	addi	a0,a0,-118 # 1488 <malloc+0x1e4>
     ...
     55e:	f4650513          	addi	a0,a0,-186 # 14a0 <malloc+0x1fc>
     ...
     58a:	ee250513          	addi	a0,a0,-286 # 1468 <malloc+0x1c4>
     ...
     5ac:	ee050513          	addi	a0,a0,-288 # 1488 <malloc+0x1e4>
     ...
     5c6:	eee50513          	addi	a0,a0,-274 # 14b0 <malloc+0x20c>
     ...
     614:	e7850513          	addi	a0,a0,-392 # 1488 <malloc+0x1e4>
     ...
     670:	e5450513          	addi	a0,a0,-428 # 14c0 <malloc+0x21c>
     ...
     69c:	e4058593          	addi	a1,a1,-448 # 14d8 <malloc+0x234>
     ...
     79e:	d8650513          	addi	a0,a0,-634 # 1520 <malloc+0x27c>
     ...
     7e4:	cf858593          	addi	a1,a1,-776 # 14d8 <malloc+0x234>
     ...
     856:	cfe50513          	addi	a0,a0,-770 # 1550 <malloc+0x2ac>
     ...
     870:	cf450513          	addi	a0,a0,-780 # 1560 <malloc+0x2bc>
     ...
     88c:	ce850513          	addi	a0,a0,-792 # 1570 <malloc+0x2cc>
     ...
     8a6:	cee50513          	addi	a0,a0,-786 # 1590 <malloc+0x2ec>
     ...
     8c0:	cfc58593          	addi	a1,a1,-772 # 15b8 <malloc+0x314>
     8c4:	4509                	li	a0,2
     ...
     8dc:	ce058593          	addi	a1,a1,-800 # 15b8 <malloc+0x314>
     8e0:	4509                	li	a0,2
     ...
     938:	c9458593          	addi	a1,a1,-876 # 15c8 <malloc+0x324>
     93c:	4509                	li	a0,2
     ...
     9ac:	b7858593          	addi	a1,a1,-1160 # 1520 <malloc+0x27c>
     9b0:	4509                	li	a0,2
     ...
     9f8:	bd458593          	addi	a1,a1,-1068 # 15c8 <malloc+0x324>
     9fc:	4509                	li	a0,2
     ...
     a3c:	b9058593          	addi	a1,a1,-1136 # 15c8 <malloc+0x324>
     a40:	4509                	li	a0,2
     ...
     aa4:	a8058593          	addi	a1,a1,-1408 # 1520 <malloc+0x27c>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	9a050513          	addi	a0,a0,-1632 # 1468 <malloc+0x1c4>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3d6080e7          	jalr	982(ra) # ea6 <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	94050513          	addi	a0,a0,-1728 # 1418 <malloc+0x174>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b10:	97c50513          	addi	a0,a0,-1668 # 1488 <malloc+0x1e4>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b52:	93a50513          	addi	a0,a0,-1734 # 1488 <malloc+0x1e4>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f56:	70e50513          	addi	a0,a0,1806 # 1660 <digits>
     f5a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1022:	642b8b93          	addi	s7,s7,1602 # 1660 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1162:	4fa90913          	addi	s2,s2,1274 # 1658 <malloc+0x3b4>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1330:	34a73a23          	sd	a0,852(a4) # 1680 <freep>
      return (void*)(p + 1);
