...
0000000000000a60 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	9d848493          	addi	s1,s1,-1576 # 1470 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9cba0a13          	addi	s4,s4,-1589 # 1473 <buf.0+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	93e50513          	addi	a0,a0,-1730 # 1470 <buf.0>
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1288:	c798                	sw	a4,8(a5)
        p += p->s.size;
    128a:	02071693          	slli	a3,a4,0x20
    128e:	01c6d713          	srli	a4,a3,0x1c
    1292:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1294:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1298:	00000717          	auipc	a4,0x0
    129c:	1ca73823          	sd	a0,464(a4) # 1468 <freep>
      return (void*)(p + 1);
    12a0:	01078513          	addi	a0,a5,16
  ...
  free((void*)(hp + 1));
    ...
    12c8:	ec4080e7          	jalr	-316(ra) # 1188 <free>
  return freep;
