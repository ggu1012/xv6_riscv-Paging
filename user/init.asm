...
main(void)
{
  ...
  6e:	89e50513          	addi	a0,a0,-1890 # 908 <malloc+0x154>
  ...
  b0:	82450513          	addi	a0,a0,-2012 # 8d0 <malloc+0x11c>
  ...
  d2:	81a50513          	addi	a0,a0,-2022 # 8e8 <malloc+0x134>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 672:	2ba90913          	addi	s2,s2,698 # 928 <malloc+0x174>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73a:	2227b783          	ld	a5,546(a5) # 958 <freep>
 ...
 768:	00e6ea63          	bltu	a3,a4,77c <free+0x50>
{
 ...
 7aa:	1af73923          	sd	a5,434(a4) # 958 <freep>
}
 7ae:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7dc:	18053503          	ld	a0,384(a0) # 958 <freep>
 ...
 804:	15890913          	addi	s2,s2,344 # 958 <freep>
  if(p == (char*)-1)
 808:	5afd                	li	s5,-1
 80a:	a895                	j	87e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80c:	00000797          	auipc	a5,0x0
 810:	15478793          	addi	a5,a5,340 # 960 <base>
 814:	00000717          	auipc	a4,0x0
 818:	14f73223          	sd	a5,324(a4) # 958 <freep>
 81c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
